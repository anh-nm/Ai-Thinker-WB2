# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blfdt/test/tc_blfdt_wifi.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blfdt/test/tc_blfdt_wifi.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blfdt/test/tc_blfdt_wifi.c" 2
...
static int tc_fdt_wifi_module(void)
{
    ...
    if (!(wifi_offset > 0)) {
        do { ; bl_printk("[%10u][%s: %s:%4d] " "wifi NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 26); ; } while(0==1);
        return -1;
    }
    ...
    if (offset1 > 0) {
        ...
        if (addr_prop) {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "value = %ld, lentmp = %d\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 35, fdt32_to_cpu(*addr_prop), lentmp); ; } while(0==1);
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "country_code NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 37); ; } while(0==1);
            return -1;
        }
    }
    ...
    if (offset1 > 0) {
        ...
        if (lentmp == 6) {
            ...
            do { ; bl_printk("[%10u][%s: %s:%4d] " "sta_mac :\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 50); ; } while(0==1);
            log_buf_out("tc_blfdt_wifi.c", 51, sta_mac, 6, LOG_BUF_OUT_DATA_TYPE_HEX);
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "sta_mac_addr NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 53); ; } while(0==1);
            return -1;
        }
        ...
        if (lentmp == 6) {
            ...
            do { ; bl_printk("[%10u][%s: %s:%4d] " "ap_mac :\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 63); ; } while(0==1);
            log_buf_out("tc_blfdt_wifi.c", 64, ap_mac, 6, LOG_BUF_OUT_DATA_TYPE_HEX);
        }
    }
    ...
    if (offset1 > 0) {
        ...
        if (countindex > 0) {
            for (i = 0; i < countindex; i++) {
                ...
                if (lentmp > 0) {
                    do { ; bl_printk("[%10u][%s: %s:%4d] " "ap string[%d] = %s, lentmp = %d\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 77, i, result, lentmp); ; } while(0==1);
                }
            }
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "ap NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 81); ; } while(0==1);
            return -1;
        }
        ...
        if (countindex > 0) {
            for (i = 0; i < countindex; i++) {
                ...
                if (lentmp > 0) {
                    ...
                    do { ; bl_printk("[%10u][%s: %s:%4d] " "pwd string[%d] = %s, lentmp = %d\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 92, i, result, lentmp); ; } while(0==1);
                }
            }
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "pwd NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 96); ; } while(0==1);
            return -1;
        }
        ...
        if (addr_prop) {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "ap_channel = %ld\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 103, fdt32_to_cpu(*addr_prop)); ; } while(0==1);
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "ap_channel NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 105); ; } while(0==1);
            return -1;
        }
        ...
        if (countindex > 0) {
            for (i = 0; i < countindex; i++) {
                ...
                if (lentmp > 0) {
                    do { ; bl_printk("[%10u][%s: %s:%4d] " "auto_chan_detect string[%d] = %s, lentmp = %d\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 115, i, result, lentmp); ; } while(0==1);
                }
            }
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "auto_chan_detect NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 119); ; } while(0==1);
            return -1;
        }
    } else {
        do { ; bl_printk("[%10u][%s: %s:%4d] " "ap NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 123); ; } while(0==1);
        return -1;
    }
    ...
    if (offset1 > 0) {
        ...
        if (lentmp == 5*4) {
            ...
            do { ; bl_printk("[%10u][%s: %s:%4d] " "xtal :\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 136); ; } while(0==1);
            log_buf_out("tc_blfdt_wifi.c", 137, xtal, 5*4, LOG_BUF_OUT_DATA_TYPE_HEX);
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "xtal NULL.", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 139); ; } while(0==1);
            return -1;
        }
        ...
        if (lentmp == 16*4*4) {
            ...
            do { ; bl_printk("[%10u][%s: %s:%4d] " "pwr_table :\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 148); ; } while(0==1);
            log_buf_out("tc_blfdt_wifi.c", 149, pwr_table, 16*4*4, LOG_BUF_OUT_DATA_TYPE_HEX);
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "pwr_table NULL. lentmp = %d.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 151, lentmp); ; } while(0==1);
            return -1;
        }
        ...
        if (lentmp == 15*4) {
            ...
            do { ; bl_printk("[%10u][%s: %s:%4d] " "channel_div_table :\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 160); ; } while(0==1);
            log_buf_out("tc_blfdt_wifi.c", 161, channel_div_table, 15*4, LOG_BUF_OUT_DATA_TYPE_HEX);
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "channel_div_table NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 163); ; } while(0==1);
            return -1;
        }
        ...
        if (lentmp == 14*4) {
            ...
            do { ; bl_printk("[%10u][%s: %s:%4d] " "channel_cnt_table :\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 172); ; } while(0==1);
            log_buf_out("tc_blfdt_wifi.c", 173, channel_cnt_table, 14*4, LOG_BUF_OUT_DATA_TYPE_HEX);
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "channel_cnt_table NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 175); ; } while(0==1);
            return -1;
        }
        ...
        if (lentmp == 1*4) {
            ...
            do { ; bl_printk("[%10u][%s: %s:%4d] " "lo_fcal_div :\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "tc_blfdt_wifi.c", 184); ; } while(0==1);
            log_buf_out("tc_blfdt_wifi.c", 185, lo_fcal_div, 1*4, LOG_BUF_OUT_DATA_TYPE_HEX);
        } else {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "lo_fcal_div NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 187); ; } while(0==1);
            return -1;
        }
    } else {
        do { ; bl_printk("[%10u][%s: %s:%4d] " "brd_rf NULL.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "tc_blfdt_wifi.c", 191); ; } while(0==1);
        return -1;
    }
