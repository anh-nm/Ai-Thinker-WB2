# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c"
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c" 2
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c" 2
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c" 2
# 17 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c"
typedef struct {
    uint8_t _id;
    uint8_t _size;
    uint16_t _offset;
...
uint8_t find_error_locator(fec_context_t *context, blpoly_t *synd, blpoly_t *erase_loc, unsigned long erase_count)
{
    ...
    if (erase_loc != 
# 506 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c" 3 4
                    ((void *)0)
# 506 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c"
                        ) {
    ...
    {
        if (erase_loc != 
# 523 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c" 3 4
                        ((void *)0)
# 523 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c"
                            ) {
...
void reedsolomon_init(void *context)
{
    ...
    do { ; bl_printk("[%10u][%s: %s:%4d] " "reedsolomon_init.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "utils_fec.c", 628); ; } while(0==1);
...
char decode_block(fec_context_t *context, void* src, const void* ecc, void* dst, uint8_t* erase_pos, unsigned long erase_count)
{
    ...
    if (erase_pos == 
# 745 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c" 3 4
                    ((void *)0)
# 745 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c"
                        ) {
        epos->length = 0;
    } else {
...
# 776 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c" 3 4
                                       ((void *)0)
# 776 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_fec.c"
                                           , epos->length);
...
int reedsolomon_getmemsize(void)
{
    ...
    do { ; bl_printk("[%10u][%s: %s:%4d] " "sizeof(fec_t) = %d   sizeof(fec_context_t) = %d\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "utils_fec.c", 839, sizeof(fec_t), sizeof(fec_context_t)); ; } while(0==1);
