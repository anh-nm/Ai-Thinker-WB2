...
bl_printk:
.LFB5:
	.file 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_log.c"
	.loc 1 138 1
	.cfi_startproc
.LVL0:
	.loc 1 139 5
...
.LVL6:
.L10:
	.loc 1 99 21 is_stmt 1 discriminator 2
	.loc 1 99 9 is_stmt 0 discriminator 2
	lw	a5,12(sp)
	beq	s3,a5,.L34
	.loc 1 100 17
	li	s2,0
...
.LVL16:
	.loc 1 94 24
	beq	a0,zero,.L24
	.loc 1 94 96 discriminator 1
	call	xTaskGetTickCountFromISR
.LVL17:
.L52:
	.loc 1 94 125 discriminator 2
	mv	a1,a0
	.loc 1 94 24 discriminator 2
	lui	a2,%hi(.LC3)
	lui	a0,%hi(.LC4)
	mv	a5,s2
	mv	a6,s3
...
.LVL18:
	...
	.loc 1 49 9 is_stmt 0 discriminator 2
	addi	a5,s6,1
.LVL19:
	addi	s0,s0,50
	bne	s6,s7,.L37
...
.LVL26:
	...
	add	s2,s2,a0
.LVL27:
	.loc 1 75 39 is_stmt 1
	.loc 1 75 29
	.loc 1 75 17 is_stmt 0
	beq	s11,a5,.L58
.LVL28:
.L11:
	.loc 1 76 21 is_stmt 1
	.loc 1 79 78 is_stmt 0
	add	a5,s0,s11
	lbu	a2,0(a5)
	.loc 1 76 21
	li	a5,1
...
.LVL35:
	.loc 1 120 20
	beq	a0,zero,.L32
	.loc 1 120 92 discriminator 1
	call	xTaskGetTickCountFromISR
.LVL36:
.L55:
	.loc 1 120 121 discriminator 2
	mv	a1,a0
	...
	call	bl_printk
.LVL37:
	.loc 1 120 177 is_stmt 1 discriminator 2
	.loc 1 120 186 discriminator 2
	.loc 1 99 28 discriminator 2
	addi	s3,s3,50
	j	.L10
.L32:
	.loc 1 120 121 is_stmt 0 discriminator 2
	call	xTaskGetTickCount
.LVL38:
	j	.L55
.LVL39:
...
.LASF35:
	.string	"/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/utils_log.c"
.LASF8:
...
.LASF2:
	.string	"signed char"
.LASF36:
	.string	"/home/anh/Desktop/wb2/Ai-Thinker-WB2/applications/get-started/config_wifi/build_out/utils"
.LASF20:
	.string	"_Bool"
.LASF30:
	.string	"sprintf"
