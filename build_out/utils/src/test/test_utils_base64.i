# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 2
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 2
...
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 2
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 2
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 2
...
static void cmd_encode(char *buf, int len, int argc, char **argv)
{
    ...
    char *inbuf, *outbuf = 
# 15 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 3 4
                          ((void *)0)
# 15 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c"
                              ;

    if (argc != 3)
    {
        do { ; bl_printk("[%10u][%s: %s:%4d] " "Usage:\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "test_utils_base64.c", 19); ; } while(0==1);
        do { ; bl_printk("[%10u][%s: %s:%4d] " "encode_base64 0x420c0000 512\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "test_utils_base64.c", 20); ; } while(0==1);
        return;
    }

    inbuf = (char *)strtol(argv[1], 
# 24 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 3 4
                                   ((void *)0)
# 24 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c"
                                       , 0);
    input_len = strtol(argv[2], 
# 25 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 3 4
                               ((void *)0)
# 25 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c"
                                   , 0);
    if (inbuf != 
# 26 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c" 3 4
                ((void *)0) 
# 26 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/src/test/test_utils_base64.c"
                     && input_len != 0)
    {
        ...
        if (outbuf)
        {
            ...
            {
                do { ; bl_printk("[%10u][%s: %s:%4d] " "base64 encode error\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "test_utils_base64.c", 45); ; } while(0==1);
            }
        ...
        {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "base64 encode mem not enough %d\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "test_utils_base64.c", 52, output_len); ; } while(0==1);
        }
    }
    else
    {
        do { ; bl_printk("[%10u][%s: %s:%4d] " "base64 encode argc error\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "test_utils_base64.c", 57); ; } while(0==1);
    }
