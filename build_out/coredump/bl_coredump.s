...
dump_base64_word:
.LFB12:
	.file 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/coredump/bl_coredump.c"
	.loc 1 264 95
	.cfi_startproc
.LVL0:
	.loc 1 265 3
...
.LFB16:
	.loc 1 362 99 is_stmt 1
	.cfi_startproc
.LVL5:
	.loc 1 363 3
	.loc 1 362 99 is_stmt 0
	addi	sp,sp,-80
...
dump_base64_byte:
.LFB10:
	.loc 1 219 95 is_stmt 1
	.cfi_startproc
.LVL69:
	.loc 1 220 3
	.loc 1 219 95 is_stmt 0
	addi	sp,sp,-32
...
.LBB248:
	.loc 1 150 3
 #APP
# 150 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/coredump/bl_coredump.c" 1
	add a4, x0, sp
# 0 "" 2
 #NO_APP
.L9:
.LBE248:
.LBE247:
	.loc 1 391 5 is_stmt 1 discriminator 1
	.loc 1 390 9 discriminator 1
.LBB250:
.LBB249:
	.loc 1 149 3 discriminator 1
	.loc 1 150 3 discriminator 1
.LVL79:
	.loc 1 152 3 discriminator 1
.LBE249:
.LBE250:
	.loc 1 390 9 is_stmt 0 discriminator 1
	bleu	a4,a5,.L9
...
dump_ascii:
.LFB8:
	.loc 1 186 89 is_stmt 1
	.cfi_startproc
.LVL120:
	.loc 1 188 3
	.loc 1 186 89 is_stmt 0
	addi	sp,sp,-16
	.cfi_def_cfa_offset 16
	sw	s0,8(sp)
	sw	s1,4(sp)
...
.L33:
	.cfi_restore_state
	.loc 1 189 5 is_stmt 1 discriminator 3
	add	a5,s0,s1
	lbu	a1,0(a5)
	mv	a0,s2
	.loc 1 188 54 is_stmt 0 discriminator 3
	addi	s1,s1,1
.LVL128:
	.loc 1 189 5 discriminator 3
	call	utils_crc32_stream_feed
.LVL129:
	.loc 1 188 51 is_stmt 1 discriminator 3
	j	.L32
	.cfi_endproc
.LFE8:
...
.LBE264:
	...
	lw	a1,4(s0)
	lw	a0,0(s0)
	.loc 1 465 7 is_stmt 0 discriminator 3
	addi	s0,s0,16
	.loc 1 466 9 discriminator 3
	call	bl_coredump_print
.LVL154:
	.loc 1 465 63 is_stmt 1 discriminator 3
...
.LVL158:
.L49:
	.loc 1 491 5 discriminator 3
	lw	a3,8(s0)
	lw	a2,12(s0)
	lw	a1,4(s0)
	lw	a0,0(s0)
	.loc 1 490 3 is_stmt 0 discriminator 3
	addi	s0,s0,16
.LVL159:
	.loc 1 491 5 discriminator 3
	call	bl_coredump_print
.LVL160:
	.loc 1 490 71 is_stmt 1 discriminator 3
	.loc 1 490 21 discriminator 3
	.loc 1 490 3 is_stmt 0 discriminator 3
	bne	s0,s1,.L49
	li	s0,12
	.loc 1 484 24
...
.LC7:
	...
	.align	2
.LC8:
	.string	"0x24B00000-0x24B0055C"
	.align	2
.LC9:
	.string	"0x24B08000-0x24B08560"
	.align	2
.LC10:
	.string	"0x24C00000-0x24C0003C"
	.align	2
.LC11:
	.string	"0x24C00800-0x24C008BC"
	.align	2
.LC12:
	.string	"others_reg"
	.align	2
...
.Letext0:
	...
	.file 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/toolchain/riscv/Linux/riscv64-unknown-elf/include/sys/types.h"
	.file 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_dma.h"
	.file 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_uart.h"
	.file 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/include/utils_crc.h"
	.file 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/toolchain/riscv/Linux/riscv64-unknown-elf/include/string.h"
	.file 11 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/include/utils_hex.h"
	.file 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/include/utils_base64.h"
	.file 13 "<built-in>"
...
.LASF137:
	.string	"/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/coredump/bl_coredump.c"
.LASF35:
...
.LASF138:
	.string	"/home/anh/Desktop/wb2/Ai-Thinker-WB2/applications/get-started/config_wifi/build_out/coredump"
.LASF18:
	.string	"ssize_t"
.LASF72:
	.string	"_sp_base"
