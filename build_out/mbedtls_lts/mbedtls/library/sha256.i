# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c"
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/applications/get-started/config_wifi/build_out/mbedtls_lts//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c"
# 25 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c"
...
# 26 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c" 2
...
# 276 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/include/mbedtls/sha256.h"
 void mbedtls_sha256( const unsigned char *input,
                                        ...
                                        unsigned char output[32],
                                        int is224 );
# 30 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c" 2
...
# 31 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c" 2
...
# 32 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c" 2
...
# 34 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c" 2
# 53 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c"
...
{
    if( ctx == 
# 62 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c" 3 4
              ((void *)0) 
# 62 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c"
                   )
        return;
...
# 173 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c"
int mbedtls_internal_sha256_process( mbedtls_sha256_context *ctx,
                                const unsigned char data[64] )
{
    struct
...
# 208 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/mbedtls_lts/mbedtls/library/sha256.c"
    for( i = 0; i < 16; i++ )
        local.W[i] = ( ( (uint32_t) ( data )[( 4 * i ) ] << 24 ) | ( (uint32_t) ( data )[( 4 * i ) + 1] << 16 ) | ( (uint32_t) ( data )[( 4 * i ) + 2] << 8 ) | ( (uint32_t) ( data )[( 4 * i ) + 3] ) );
                               ...
                               unsigned char output[32] )
{
    ...
    { ( output )[( 20 ) ] = ( (uint8_t) ( ( ( ctx->state[5] ) >> 24 ) & 0xff ) ); ( output )[( 20 ) + 1] = ( (uint8_t) ( ( ( ctx->state[5] ) >> 16 ) & 0xff ) ); ( output )[( 20 ) + 2] = ( (uint8_t) ( ( ( ctx->state[5] ) >> 8 ) & 0xff ) ); ( output )[( 20 ) + 3] = ( (uint8_t) ( ( ctx->state[5] ) & 0xff ) ); };
    { ( output )[( 24 ) ] = ( (uint8_t) ( ( ( ctx->state[6] ) >> 24 ) & 0xff ) ); ( output )[( 24 ) + 1] = ( (uint8_t) ( ( ( ctx->state[6] ) >> 16 ) & 0xff ) ); ( output )[( 24 ) + 2] = ( (uint8_t) ( ( ( ctx->state[6] ) >> 8 ) & 0xff ) ); ( output )[( 24 ) + 3] = ( (uint8_t) ( ( ctx->state[6] ) & 0xff ) ); };

    if( ctx->is224 == 0 )
        { ( output )[( 28 ) ] = ( (uint8_t) ( ( ( ctx->state[7] ) >> 24 ) & 0xff ) ); ( output )[( 28 ) + 1] = ( (uint8_t) ( ( ( ctx->state[7] ) >> 16 ) & 0xff ) ); ( output )[( 28 ) + 2] = ( (uint8_t) ( ( ( ctx->state[7] ) >> 8 ) & 0xff ) ); ( output )[( 28 ) + 3] = ( (uint8_t) ( ( ctx->state[7] ) & 0xff ) ); };
