# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/applications/get-started/config_wifi/build_out/freertos_riscv_ram//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
# 29 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
...
# 30 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c" 2
...
# 38 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c" 2
...
# 39 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c" 2
...
# 40 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c" 2
...
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c" 2
# 63 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
...
# 87 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
static BaseType_t prvTestWaitCondition( const EventBits_t uxCurrentEventBits, const EventBits_t uxBitsToWaitFor, const BaseType_t xWaitForAllBits ) ;
 ...
 EventGroup_t *pxEventBits;
  ...
  if( ( pxEventGroupBuffer ) == 0 ) vEnvironmentCall((1 << 1));
...

  {
   ...
   if( ( xSize == sizeof( EventGroup_t ) ) == 0 ) vEnvironmentCall((1 << 1));
  }
  ...
  if( pxEventBits != 
# 113 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c" 3 4
                    ((void *)0) 
# 113 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
                         )
  {
 ...
 {
 EventGroup_t *pxEventBits;
# 162 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
  pxEventBits = ( EventGroup_t * ) pvPortMalloc( sizeof( EventGroup_t ) );

  if( pxEventBits != 
# 164 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c" 3 4
                    ((void *)0) 
# 164 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
                         )
  {
   pxEventBits->uxEventBits = 0;
   vListInitialise( &( pxEventBits->xTasksWaitingForBits ) );
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
 ...
 if( ( ( uxBitsToWaitFor & 0xff000000UL ) == 0 ) == 0 ) vEnvironmentCall((1 << 1));
 if( ( uxBitsToWaitFor != 0 ) == 0 ) vEnvironmentCall((1 << 1));
...
BaseType_t xTimeoutOccurred = ( ( BaseType_t ) 0 );
 ...
 if( ( xEventGroup ) == 0 ) vEnvironmentCall((1 << 1));
 if( ( ( uxBitsToWaitFor & 0xff000000UL ) == 0 ) == 0 ) vEnvironmentCall((1 << 1));
 if( ( uxBitsToWaitFor != 0 ) == 0 ) vEnvironmentCall((1 << 1));
...
EventBits_t uxReturn;
 ...
 if( ( xEventGroup ) == 0 ) vEnvironmentCall((1 << 1));
 if( ( ( uxBitsToClear & 0xff000000UL ) == 0 ) == 0 ) vEnvironmentCall((1 << 1));
...
# 495 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c" 3 4
                                                                                                                            ((void *)0) 
# 495 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
                                                                                                                                 );
...
BaseType_t xMatchFound = ( ( BaseType_t ) 0 );
 ...
 if( ( xEventGroup ) == 0 ) vEnvironmentCall((1 << 1));
 if( ( ( uxBitsToSet & 0xff000000UL ) == 0 ) == 0 ) vEnvironmentCall((1 << 1));
...
const List_t *pxTasksWaitingForBits = &( pxEventBits->xTasksWaitingForBits );
 ...
 vTaskSuspendAll();
 {
  ...
  while( ( ( pxTasksWaitingForBits )->uxNumberOfItems ) > ( UBaseType_t ) 0 )
  {
   ...
   if( ( pxTasksWaitingForBits->xListEnd.pxNext != ( const ListItem_t * ) &( pxTasksWaitingForBits->xListEnd ) ) == 0 ) vEnvironmentCall((1 << 1));
   vTaskRemoveFromUnorderedEventList( pxTasksWaitingForBits->xListEnd.pxNext, 0x02000000UL );
  }
# 637 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
  {
...
BaseType_t xWaitConditionMet = ( ( BaseType_t ) 0 );
 ...
 EventGroup_t const *pxEventBits = ( EventGroup_t * ) xEventGroup;
  ...
  if( xEventGroup == 
# 728 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c" 3 4
                    ((void *)0) 
# 728 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/event_groups.c"
                         )
  {
   xReturn = 0;
  }
