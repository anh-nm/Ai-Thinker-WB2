# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 2
...
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 2
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/include/vfs_conf.h" 1
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 2
...
# 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/include/utils_rbtree.h" 1
# 38 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/include/utils_rbtree.h"
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/toolchain/riscv/Linux/lib/gcc/riscv64-unknown-elf/10.2.0/include/stddef.h" 1 3 4
...
# 11 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 2
...
# 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 2


struct rb_tree *inode_rb_tree = 
# 14 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
                               ((void *)0)
# 14 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                                   ;
...
static int inode_cmp_cb (struct rb_tree *self, struct rb_node *node_a, struct rb_node *node_b)
{
    ...
    if (((a)->type == (VFS_TYPE_FS_DEV)) ^ ((b)->type == (VFS_TYPE_FS_DEV))) {
        ret = strncmp(a->i_name, b->i_name, ((a)->type == (VFS_TYPE_FS_DEV)) ? strlen(a->i_name) : strlen(b->i_name));
        if (!ret && strlen(a->i_name) != strlen(b->i_name)) {
            ret = ((a)->type == (VFS_TYPE_FS_DEV)) ? strncmp(b->i_name + strlen(a->i_name), "/", 1) : strncmp(a->i_name + strlen(b->i_name), "/", 1);
            goto exit;
        }
        goto exit;
    }
...
int inode_init()
{
    int ret = 0;
    if (
# 37 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
       ((void *)0) 
# 37 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
            == inode_rb_tree) {
        inode_rb_tree = rb_tree_create(inode_cmp_cb);
        if (
# 39 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
           ((void *)0) 
# 39 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                == inode_rb_tree) {
            ret = -1;
        }
    }
...
int inode_alloc(inode_t **node)
{
    *node = pvPortMalloc(sizeof(inode_t));
    ...
    do { if (!(
# 50 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0) 
# 50 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
   != *node)) { puts("VFS_ASSERT:" "NULL != *node"); printf(" %s:%d\r\n", "vfs_inode.c", 50); while(1); } } while(0);
...
int inode_del(inode_t *node)
{
    if (node->refs > 0) {
        return -
# 60 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3
               16
# 60 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                    ;
    }
    ...
    if (node->refs == 0) {
        ...
        if (node->i_name != 
# 65 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
                           ((void *)0)
# 65 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                               ) {
...
int inode_forearch_name(int (*cb)(void *arg, inode_t *node), void *arg)
{
    ...
    if (
# 96 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
       ((void *)0) 
# 96 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
            == iter) {
        node_num = 0;
        goto exit;
    }
    ...
    if (
# 103 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
       ((void *)0) 
# 103 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
            == node) {
    ...
    for (i = 0; i < node_num; i++) {
        if (
# 110 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
           ((void *)0) 
# 110 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                != node->i_name) {
            if (cb(arg, node)) {
                break;
            }
        ...
        if (
# 116 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
           ((void *)0) 
# 116 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                == node) {
            break;
        }
    }
...
int inode_ptr_get(int fd, inode_t **node)
{
# 136 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
    return 0u;
}
...
int inode_avail_count(void)
{
    return 30 - rb_tree_size(inode_rb_tree);
}
...
static int inode_set_name(const char *path, inode_t **inode)
{
    ...
    do { if (!(
# 169 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0) 
# 169 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
   != mem)) { puts("VFS_ASSERT:" "NULL != mem"); printf(" %s:%d\r\n", "vfs_inode.c", 169); while(1); } } while(0);
...
int inode_reserve(const char *path, inode_t **inode)
{
    int ret;
    inode_t *node = 
# 181 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
                   ((void *)0)
# 181 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                       ;

    do { if (!(path != 
# 183 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0) 
# 183 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
   && inode != 
# 183 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0)
# 183 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
   )) return -
# 183 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3
   22
# 183 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
   ; } while(0);
    *inode = 
# 184 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
            ((void *)0)
# 184 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                ;
    ...
    if (path[0] == '\0' || path[0] != '/') {
        ...
        return -
# 192 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3
               22
# 192 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                     ;
    }

    if (
# 195 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
       ((void *)0) 
# 195 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
            == inode_rb_tree || 30 <= rb_tree_size(inode_rb_tree)) {
        printf("inode_rb_tree is NULL when inode alloc\r\n");
        return -
# 197 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3
               22
# 197 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
    ...
    if (!(rb_tree_insert(inode_rb_tree, node))) {
        ...
        vPortFree(node);
        return -
# 214 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3
               12
# 214 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
...
int inode_release(const char *path)
{
    ...
    do { if (!(path != 
# 226 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
   ((void *)0)
# 226 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
   )) return -
# 226 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3
   22
# 226 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
   ; } while(0);
    ...
    if (node == 
# 229 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3 4
               ((void *)0)
# 229 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                   ) {
        return -
# 230 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c" 3
               19
# 230 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/fs/vfs/src/vfs_inode.c"
                     ;
    }
