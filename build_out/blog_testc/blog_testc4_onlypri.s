...
.LC1:
	...
	.align	2
.LC2:
	.string	"%s (%d)[%s:%4d] blog_testc4 debug user\r\n\033[0m\r\n"
	.align	2
.LC3:
	.string	"\033[32mINFO"
	.align	2
.LC4:
	.string	"%s (%d)[%s:%4d] blog_testc4 info user\r\n\033[0m\r\n"
	.align	2
.LC5:
	.string	"\033[33mWARN"
	.align	2
.LC6:
	.string	"%s (%d)[%s:%4d] blog_testc4 warn user\r\n\033[0m\r\n"
	.align	2
.LC7:
	.string	"\033[31mERROR"
	.align	2
.LC8:
	.string	"%s (%d)[%s:%4d] blog_testc4 error user\r\n\033[0m\r\n"
	.align	2
.LC9:
	.string	"\033[35mASSERT"
	.align	2
.LC10:
	.string	"%s (%d)[%s:%4d] blog_testc4 assert user\r\n\033[0m\r\n"
...
blog_testc4_entry:
.LFB4:
	.file 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog_testc/blog_testc4_onlypri.c"
	.loc 1 10 1
	.cfi_startproc
.LVL0:
	.loc 1 11 5
...
.L4:
	...
	.loc 1 14 307 is_stmt 0 discriminator 7
	call	xPortIsInsideInterrupt
.LVL3:
	.loc 1 14 216 discriminator 7
	beq	a0,zero,.L12
	.loc 1 14 336 discriminator 9
	call	xTaskGetTickCountFromISR
.LVL4:
.L55:
	.loc 1 14 367 discriminator 10
	mv	a2,a0
...
.L3:
	...
	.loc 1 13 305 is_stmt 0 discriminator 7
	call	xPortIsInsideInterrupt
.LVL6:
	.loc 1 13 219 discriminator 7
	beq	a0,zero,.L6
	.loc 1 13 334 discriminator 9
	call	xTaskGetTickCountFromISR
.LVL7:
.L54:
	.loc 1 13 365 discriminator 10
	mv	a2,a0
...
.LVL8:
.L2:
	.loc 1 13 427 is_stmt 1 discriminator 1
	.loc 1 13 438 discriminator 1
	...
	bleu	a4,a5,.L8
.L9:
	.loc 1 14 429 is_stmt 1 discriminator 1
	.loc 1 14 440 discriminator 1
...
.L10:
	...
	.loc 1 15 307 is_stmt 0 discriminator 7
	call	xPortIsInsideInterrupt
.LVL9:
	.loc 1 15 216 discriminator 7
	beq	a0,zero,.L17
	.loc 1 15 336 discriminator 9
	call	xTaskGetTickCountFromISR
.LVL10:
.L56:
	.loc 1 15 367 discriminator 10
	mv	a2,a0
...
.LVL11:
.L14:
	.loc 1 15 429 is_stmt 1 discriminator 1
	.loc 1 15 440 discriminator 1
...
.L15:
	...
	.loc 1 16 312 is_stmt 0 discriminator 7
	call	xPortIsInsideInterrupt
.LVL12:
	.loc 1 16 219 discriminator 7
	beq	a0,zero,.L22
	.loc 1 16 341 discriminator 9
	call	xTaskGetTickCountFromISR
.LVL13:
.L57:
	.loc 1 16 372 discriminator 10
	mv	a2,a0
...
.LVL14:
.L19:
	.loc 1 16 434 is_stmt 1 discriminator 1
	.loc 1 16 445 discriminator 1
...
.L20:
	...
	.loc 1 17 317 is_stmt 0 discriminator 7
	call	xPortIsInsideInterrupt
.LVL15:
	.loc 1 17 222 discriminator 7
	beq	a0,zero,.L25
	.loc 1 17 346 discriminator 9
	call	xTaskGetTickCountFromISR
.LVL16:
.L58:
	.loc 1 17 377 discriminator 10
	mv	a2,a0
...
.L24:
	...
	lui	s8,%hi(.LC5)
.L27:
	.loc 1 17 439 is_stmt 1 discriminator 13
	.loc 1 17 450 discriminator 13
...
.L30:
	...
	.loc 1 22 311 is_stmt 0 discriminator 7
	call	xPortIsInsideInterrupt
.LVL19:
	.loc 1 22 220 discriminator 7
	beq	a0,zero,.L38
	.loc 1 22 340 discriminator 9
	call	xTaskGetTickCountFromISR
.LVL20:
.L60:
	.loc 1 22 371 discriminator 10
	mv	a2,a0
...
.L29:
	...
	.loc 1 21 309 is_stmt 0 discriminator 7
	call	xPortIsInsideInterrupt
.LVL27:
	.loc 1 21 223 discriminator 7
	beq	a0,zero,.L32
	.loc 1 21 338 discriminator 9
	call	xTaskGetTickCountFromISR
.LVL28:
.L59:
	.loc 1 21 369 discriminator 10
	mv	a2,a0
...
.LVL29:
.L28:
	.loc 1 21 431 is_stmt 1 discriminator 1
	.loc 1 21 442 discriminator 1
	...
	bleu	a4,a5,.L34
.L35:
	.loc 1 22 433 is_stmt 1 discriminator 1
	.loc 1 22 444 discriminator 1
...
.L36:
	...
	.loc 1 23 311 is_stmt 0 discriminator 7
	call	xPortIsInsideInterrupt
.LVL30:
	.loc 1 23 220 discriminator 7
	beq	a0,zero,.L43
	.loc 1 23 340 discriminator 9
	call	xTaskGetTickCountFromISR
.LVL31:
.L61:
	.loc 1 23 371 discriminator 10
	mv	a2,a0
...
.LVL32:
.L40:
	.loc 1 23 433 is_stmt 1 discriminator 1
	.loc 1 23 444 discriminator 1
...
.L41:
	...
	.loc 1 24 316 is_stmt 0 discriminator 7
	call	xPortIsInsideInterrupt
.LVL33:
	.loc 1 24 223 discriminator 7
	beq	a0,zero,.L48
	.loc 1 24 345 discriminator 9
	call	xTaskGetTickCountFromISR
.LVL34:
.L62:
	.loc 1 24 376 discriminator 10
	mv	a2,a0
...
.LVL35:
.L45:
	.loc 1 24 438 is_stmt 1 discriminator 1
	.loc 1 24 449 discriminator 1
...
.L46:
	...
	.loc 1 25 321 is_stmt 0 discriminator 7
	call	xPortIsInsideInterrupt
.LVL36:
	.loc 1 25 226 discriminator 7
	beq	a0,zero,.L50
	.loc 1 25 350 discriminator 9
	call	xTaskGetTickCountFromISR
.LVL37:
.L63:
	.loc 1 25 381 discriminator 10
	mv	a2,a0
...
.LASF37:
	.string	"/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog_testc/blog_testc4_onlypri.c"
.LASF1:
