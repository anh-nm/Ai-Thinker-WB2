# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/applications/get-started/config_wifi/build_out/wifi_manager//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
# 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
...
# 11 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 2
...
# 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 2
...
# 45 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/lwip/src/include/lwip/etharp.h"
...
# 46 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/lwip/src/include/lwip/etharp.h" 2
...
# 50 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/lwip/src/include/lwip/etharp.h" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/lwip/src/include/lwip/ip4_addr.h" 1
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/lwip/src/include/lwip/ip4_addr.h"
...
# 42 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/lwip/src/include/lwip/ip4_addr.h" 2
...
# 13 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 2
...
# 14 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 2
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.h" 2
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.h" 2
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.h" 2
...
void bl_irq_handler();
# 16 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 2
...
# 17 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 2
...
# 67 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
void bl_tx_push(struct bl_hw *bl_hw, struct bl_txhdr *txhdr)
{
    ...
    do { if (!(txdesc_host)) { g_bl_ops_funcs._assert("/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c", 74, __FUNCTION__, "txdesc_host"); } } while (0);
...
void bl_tx_resend()
{
    ...
    while (txhdr_pos_r != txhdr_pos_w) {
        if (
# 96 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 3 4
           ((void *)0) 
# 96 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
...
void bl_tx_try_flush()
{
    ...
    while (ipc_host_txdesc_get(bl_hw_static->ipc_env)) {
        ...
        if (
# 116 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 3 4
           ((void *)0) 
# 116 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
                == txhdr) {
            break;
        }
...
int bl_txdatacfm(void *pthis, void *host_id)
{
    ...
    if (bl_txst.value & (1 << 16)) {
        ...
        if (((txhdr_pos_w + 1) & (0x7)) != (txhdr_pos_r & (0x7))) {
            g_bl_ops_funcs._log_write(LOG_LEVEL_WARN, 
# 147 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 3 4
           ((void *)0)
# 147 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
           , "bl_tx.c", 147, " push back\r\n");;
            txhdr_hodler[txhdr_pos_w & (0x7)] = txhdr;
            txhdr_pos_w++;
        } else {
            g_bl_ops_funcs._log_write(LOG_LEVEL_WARN, 
# 151 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 3 4
           ((void *)0)
# 151 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
           , "bl_tx.c", 151, " NOT push back when no mem\r\n");;
            pbuf_free(p);
        }
    } else {
        pbuf_free(p);
...
err_t bl_output(struct bl_hw *bl_hw, struct netif *netif, struct pbuf *p, int is_sta, struct bl_custom_tx_cfm *custom_cfm)
{
    ...
    if (
# 183 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 3 4
       ((void *)0) 
# 183 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
            == bl_hw || (0 == (0x04U & netif->flags) && eth->h_proto != 0x8e88)) {
        g_bl_ops_funcs._printf("[TX] wifi is down, return now\r\n");
        return ERR_CONN;
    }
# 197 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
    bl_hw_static = bl_hw;
    packet_len = p->tot_len;


    if (pbuf_header(p, 128u)) {
        g_bl_ops_funcs._printf("[TX] Reserve room failed for header\r\n");
        return ERR_IF;
    }
    ...
    if (16 + sizeof(struct bl_txhdr) + ((4 - (((uint32_t)p->payload) & (4 - 1))) & (4 - 1)) > 128u) {
        g_bl_ops_funcs._printf("link_header size is %ld vs header %u\r\n", sizeof(struct bl_txhdr) + ((4 - (((uint32_t)p->payload) & (4 - 1))) & (4 - 1)), 128u)
    ...
    (void)sta;
    (void)tid;
# 250 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
    loop = 0;
    for (q = p; q != 
# 251 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c" 3 4
                    ((void *)0)
# 251 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
                        ; q = q->next) {
        if (0 == loop) {
            ...
            if (loop >= 4) {
                ...
                g_bl_ops_funcs._printf("[TX] [PBUF] Please fix for bigger chained pbuf, total_len %d\r\n", p->tot_len)

                 ;
            }
            host->pbuf_chained_ptr[loop] = (uint32_t)(q->payload);
            host->pbuf_chained_len[loop] = q->len;
# 278 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/bl_tx.c"
        }
        loop++;
    }
    if (loop > 2) {
        g_bl_ops_funcs._printf("[TX] [LOOP] Chain Used %d\r\n", loop);
    }
