# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_api.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_api.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_api.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_api.h" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_api.c" 2
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_api.c" 2
...
int wifi_mgmr_api_connect(char *ssid, char *passphr, const ap_connect_adv_t *ext_param)
{
    ...
    profile->passphr_len = passphr ? strlen(passphr) : 0;
    ...
    profile->psk_len = ext_param->psk ? strlen(ext_param->psk) : 0;
    ...
    if (ext_param->ap_info.freq > 0) {
        ...
        g_bl_ops_funcs._printf("wifi mgmr band:%d freq: %d\r\n", profile->band, profile->freq);
    }
    ...
    if (ext_param->ap_info.type == AP_INFO_TYPE_PRESIST) {
        ...
        profile->ap_info_ttl = -1;
        g_bl_ops_funcs._printf("invalid ap info type or time_to_live value!\r\n");
    }
...
int wifi_mgmr_api_fw_scan(wifi_mgmr_scan_params_t scan_params)
{
    ...
    uint8_t buffer[sizeof(wifi_mgmr_msg_t) + sizeof(wifi_mgmr_scan_params_t)];
    struct mac_ssid *ssid = 
# 236 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_api.c" 3 4
                           ((void *)0)
# 236 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_api.c"
                               ;
    ...
    memcpy(ch_req->bssid, scan_params.bssid, 6);
    ssid = &(ch_req->ssid);
...
int wifi_mgmr_api_ap_start(char *ssid, char *passwd, int channel, uint8_t hidden_ssid, int8_t max_sta_supported, uint8_t use_dhcp_server)
{
    ...
    if (
# 278 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_api.c" 3 4
       ((void *)0) 
# 278 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/network/wifi_manager/bl60x_wifi_driver/wifi_mgmr_api.c"
            == ssid) {
    ...
    if (passwd && (ap->psk_len = strlen(passwd)) > 64) {
        return -1;
    }
