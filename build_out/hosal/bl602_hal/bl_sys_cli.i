# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys_cli.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys_cli.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys_cli.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys_cli.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys_cli.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalbl_sys_cli;
    const blog_info_t _fsymf_info_hosalbl_sys_cli __attribute__((used, section(".static_blogfile_code." "hosalbl_sys_cli"))) = { (blog_level_t *)(&_fsymf_level_hosalbl_sys_cli), (char *)("hosal.bl_sys_cli")};
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys_cli.c" 2
...
static void clk(void *para)
{
    ...
    int hdiv = p->hdiv;
    int bdiv = p->bdiv;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sys_cli)) { bl_printk("%s (%d)[%s:%4d] " "hdiv:%d, bdiv:%d\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sys_cli.c", 19, hdiv, bdiv); } } while (0 == 1); };
    ...
    vTaskExitCritical();
    vTaskDelete(
# 26 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys_cli.c" 3 4
               ((void *)0)
# 26 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys_cli.c"
                   );
}
...
static void cmd_clk_change(char *buf, int len, int argc, char **argv)
{
    para_div clk_div;
    if (3 != argc) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_sys_cli)) { bl_printk("%s (%d)[%s:%4d] " "please input para!\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sys_cli.c", 33); } } while (0 == 1); };
        return;
    } else {
        clk_div.hdiv = atoi(argv[1]);
        clk_div.bdiv = atoi(argv[2]);
        xTaskCreate(clk, (char*)"clk", 512, &clk_div, 20, 
# 38 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys_cli.c" 3 4
                                                         ((void *)0) 
# 38 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys_cli.c"
                                                              );
    }
}
