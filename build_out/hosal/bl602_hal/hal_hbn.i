# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c"
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys.h" 2


# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sys.h"
typedef enum {
    BL_RST_POWER_OFF = 0,
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 2
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 2
...
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 2
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 2
...
# 11 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/include/utils_notifier.h" 1
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/include/utils_notifier.h" 2
...
# 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalhal_hbn;
    const blog_info_t _fsymf_info_hosalhal_hbn __attribute__((used, section(".static_blogfile_code." "hosalhal_hbn"))) = { (blog_level_t *)(&_fsymf_level_hosalhal_hbn), (char *)("hosal.hal_hbn")};
...
# 13 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 2

static ntf_list_t *hbn_list = 
# 14 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 3 4
                             ((void *)0)
# 14 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c"
                                 ;
...
static int ntf_init(void)
{
    ...
    if (!hbn_list) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbn)) { bl_printk("%s (%d)[%s:%4d] " "malloc error.\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbn.c", 20); } } while (0 == 1); };
        return -1;
    }
...
# 29 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 3 4
                                ((void *)0)
# 29 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c"
                                    ;

    if (!hbn_list) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbn)) { bl_printk("%s (%d)[%s:%4d] " "ntfgpio not init.\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbn.c", 32); } } while (0 == 1); };
        return -1;
    }
    hbn_node = pvPortMalloc(sizeof(utils_notifier_t));
    if (!hbn_node) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbn)) { bl_printk("%s (%d)[%s:%4d] " "malloc error.\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbn.c", 37); } } while (0 == 1); };
        return -1;
    }
    hbn_node->cb = cb;
    hbn_node->cb_arg = arg;
...
{
    hbn_type_t *hbn = 
# 50 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c" 3 4
                     ((void *)0)
# 50 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbn.c"
                         ;

    if ((pinbuf_size == 0) || (pinbuf_size > 128)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbn)) { bl_printk("%s (%d)[%s:%4d] " "arg error.\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbn.c", 53); } } while (0 == 1); };
        return -1;
    }
    hbn = pvPortMalloc(pinbuf_size + sizeof(hbn_type_t));
    if (!hbn) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbn)) { bl_printk("%s (%d)[%s:%4d] " "mem error""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbn.c", 58); } } while (0 == 1); };
        return -1;
    }
