# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_timer.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_timer.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_common.h" 1
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_timer.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_timer.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_timer.h" 1
# 19 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_timer.h"
...
# 49 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_timer.h"
int hosal_timer_init(hosal_timer_dev_t *tim);
# 60 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_timer.h"
int hosal_timer_start(hosal_timer_dev_t *tim);
# 69 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_timer.h"
void hosal_timer_stop(hosal_timer_dev_t *tim);
# 80 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_timer.h"
int hosal_timer_finalize(hosal_timer_dev_t *tim);
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_timer.c" 2
...
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_timer.c" 2
...
int hosal_timer_start(hosal_timer_dev_t *tim)
{
  ...
  TIMER_Enable(TIMER_CH1);
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_timer)) { bl_printk("%s (%d)[%s:%4d] " "timer channel %d not exists\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_timer.c", 98, tim->port); } } while (0 == 1); };
  return -1;
    }
    return 0;
}
...
int hosal_timer_finalize(hosal_timer_dev_t *tim)
{
  ...
  TIMER_Disable(TIMER_CH1);
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_timer)) { bl_printk("%s (%d)[%s:%4d] " "timer channel %d not exists\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_timer.c", 131, tim->port); } } while (0 == 1); };
  return -1;
    }
    return 0;
}
