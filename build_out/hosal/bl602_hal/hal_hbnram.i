# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.h" 1
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalhal_hbnram;
    const blog_info_t _fsymf_info_hosalhal_hbnram __attribute__((used, section(".static_blogfile_code." "hosalhal_hbnram"))) = { (blog_level_t *)(&_fsymf_level_hosalhal_hbnram), (char *)("hosal.hal_hbnram")};
...
# 11 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 2
# 38 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
...
static int sha_check_withctx(uint8_t *input, uint8_t *output, bl_sha_type_t shaType, uint32_t data_size, uint32_t length)
{
    ...
    if (bl_sha_finish(&shaCtx, output) != 0) {
     if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "Sec_Eng_SHA256_Finish error \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 102); } } while (0 == 1); };
    }
    bl_sha_mutex_give();
...
static uint8_t *get_avaible_area(void)
{
    ...
    return 
# 127 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
          ((void *)0)
# 127 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
              ;
}
...
static uint8_t *find_addr_by_key(uint8_t *key)
{
    ...
    return 
# 147 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
          ((void *)0)
# 147 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
              ;
}
...
void print_mem_map(void)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "|head-64bytes|\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 157); } } while (0 == 1); };
    memset(keybuf, 0, 5);
    paddr = (uint8_t *)(0x40010000 + (16 + 4 + 40 + 4));
    while (paddr < (uint8_t *)(0x40010000 + 4096)) {
        val = *(uint32_t *)paddr;
        if (val != 0) {
            ...
            len = *(uint32_t *)(paddr + 4 + 4);
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "|%s:head-12bytes data-%ldbytes|\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 165, keybuf, len); } } while (0 == 1); };
        } else {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "|unused-%ldbytes|\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 167, (uint32_t)((uint8_t *)(0x40010000 + 4096) - paddr)); } } while (0 == 1); };
            return ;
        }
...
int hal_hbnram_init(void)
{
    ...
    if (0x12345678 != magic_val) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "magic is not right ,recalculate.\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 187); } } while (0 == 1); };
        ...
        *(uint32_t *)0x40010000 = (uint32_t)0x12345678;
        ...
        if (flag == 0) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "hash check success \r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 199); } } while (0 == 1); };
        } else {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "hash check failed, memset mem \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 201); } } while (0 == 1); };
            memset_fourbytes((uint8_t *)0x40010000, 0, 4096);
            sha_check_withctx((uint8_t*)(0x40010000 + 4 + 16), output, BL_SHA256, 32, 4096 - 4 - 16);
            mem_fourbytes_copy((uint8_t *)(0x40010000 + 4), output, 16);
            return -1;
...
int hal_hbnram_alloc(const char *key, int len)
{
    ...
    if ((strlen(key) > 4) || (len <= 0)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "illegal para. \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 228); } } while (0 == 1); };
        return -1;
    }

    paddr = get_avaible_area();
    if (paddr == 
# 233 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 233 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "do not have area for alloc. \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 234); } } while (0 == 1); };
        return -1;
    }
    ...
    if (paddr + alen + (4 + 4 + 4) > (uint8_t *)(0x40010000 + 4096)) {
        ...
        if (left_size < 0) {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "not have enough area for alloc \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 247); } } while (0 == 1); };
        } else {
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "only left %d bytes, not enough for alloc \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 249, left_size); } } while (0 == 1); };
        }
...
int hal_hbnram_buffer_set(const char *key, uint8_t *buf, int length)
{
    ...
    if (key == 
# 274 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 274 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                   || buf == 
# 274 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                             ((void *)0) 
# 274 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                                  || length <= 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "illegal para \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 275); } } while (0 == 1); };

        return -1;
    }

    if (strlen(key) > 4) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "key oversize \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 281); } } while (0 == 1); };
        return -1;
    }
    ...
    if (phead == 
# 288 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 288 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "not correct key, return \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 289); } } while (0 == 1); };
    ...
    if (length > area_size) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "length is too big than alloc size\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 297); } } while (0 == 1); };
        return -1;
    }
...
int hal_hbnram_buffer_get(const char *key, uint8_t *buf, int length)
{
    ...
    if (buf == 
# 329 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 329 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                   || key == 
# 329 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                             ((void *)0) 
# 329 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                                  || length <=0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "illegal para \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 330); } } while (0 == 1); };
        return -1;
    }

    if (strlen(key) > 4) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "key oversize \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 335); } } while (0 == 1); };
    }
    ...
    phead = find_addr_by_key(keybuf);
    if (phead == 
# 341 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 341 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "key not correct, return \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 342); } } while (0 == 1); };
        return -1;
    }

    area_size = *(uint32_t *)(phead + 4 + 4);
    if (length > area_size) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "length is big than alloc size \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 348); } } while (0 == 1); };
        return -1;
    }
...
int hal_hbnram_handle_get_fromkey(const char *key, hbnram_handle_t *handle)
{
    ...
    if (key == 
# 374 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 374 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                   || handle == 
# 374 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                                ((void *)0)
# 374 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "invalid handle pointer \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 375); } } while (0 == 1); };

        return -1;
    }

    if (strlen(key) > 4) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "key oversize \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 381); } } while (0 == 1); };
    }
    ...
    phead = find_addr_by_key(keybuf);
    if (phead == 
# 387 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                ((void *)0)
# 387 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "invalid key \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 388); } } while (0 == 1); };
        return -1;
    }
...
int hal_hbnram_copy_from_stream(hbnram_handle_t *handle, uint8_t *buf, int len)
{
    ...
    if (buf == 
# 408 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 408 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                   || handle == 
# 408 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                                ((void *)0)
# 408 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "invalid pointer \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 409); } } while (0 == 1); };
        return -1;
    }

    if (len <= 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "len == 0 \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 414); } } while (0 == 1); };
        return -1;
    }

    if (len + handle->read_idex > handle->size) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "len oversize \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 419); } } while (0 == 1); };
        return -1;
    }
...
int hal_hbnram_copy_to_stream(hbnram_handle_t *handle, uint8_t *buf, int len)
{
    ...
    if (buf == 
# 477 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
              ((void *)0) 
# 477 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                   || handle == 
# 477 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c" 3 4
                                ((void *)0)
# 477 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_hbnram.c"
                                    ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "invalid  pointer. \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 478); } } while (0 == 1); };
    }

    if (len + handle->write_idex > handle->size) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "len oversize \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 482); } } while (0 == 1); };
    }

    if (len <= 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_hbnram)) { bl_printk("%s (%d)[%s:%4d] " "len <= 0 , return \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_hbnram.c", 486); } } while (0 == 1); };
        return -1;
    }
