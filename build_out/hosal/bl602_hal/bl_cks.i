# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.h" 1


int bl_cks_test(void);
# 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalbl_cks;
    const blog_info_t _fsymf_info_hosalbl_cks __attribute__((used, section(".static_blogfile_code." "hosalbl_cks"))) = { (blog_level_t *)(&_fsymf_level_hosalbl_cks), (char *)("hosal.bl_cks")};
...
# 11 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 2
...
static void _bl_cks_test_case1()
{
    ...
    *(volatile uint8_t*)0x4000A700 = 0x1;
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS result with LE is %04x, should be %02x%02x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 35, cks, data_src1_cks[1], data_src1_cks[0]); } } while (0 == 1); };
    ...
    *(volatile uint8_t*)0x4000A700 = 0x2;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS result with BE is %04x, should be %02x%02x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 43, cks, data_src1_cks[1], data_src1_cks[0]); } } while (0 == 1); };
}
...
static void _bl_cks_test_case2()
{
    ...
    *(volatile uint8_t*)0x4000A700 = 0x1;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS LE result is %04x, %04x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 65, cks, (uint16_t)~checksum); } } while (0 == 1); }
    ...
    *(volatile uint8_t*)0x4000A700 = 0x2;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS BE result is %04x, %04x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 83, cks, (uint16_t)~checksum); } } while (0 == 1); }


     ;
    if (cks == ((uint16_t)~checksum)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Success %04X Checksum=====\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 88, cks); } } while (0 == 1); };
    } else {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Failed %04X Checksum======\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 90, cks); } } while (0 == 1); };
    }
}
...
static void _bl_cks_test_case3()
{
    ...
    *(volatile uint8_t*)0x4000A700 = 0x1;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS LE result is %04x, %04x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 113, cks, (uint16_t)~checksum); } } while (0 == 1); }
    ...
    *(volatile uint8_t*)0x4000A700 = 0x2;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS BE result is %04x, %04x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 131, cks, (uint16_t)~checksum); } } while (0 == 1); }


     ;
    if (cks == ((uint16_t)~checksum)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Success %04X Checksum=====\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 136, cks); } } while (0 == 1); };
    } else {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Failed %04X Checksum======\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 138, cks); } } while (0 == 1); };
    }
}
...
static void _bl_cks_test_case4()
{
    ...
    *(volatile uint8_t*)0x4000A704 = data_segment_two;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS LE result is %04x, %04x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 164, cks, (uint16_t)~checksum); } } while (0 == 1); }
    ...
    *(volatile uint8_t*)0x4000A704 = data_segment_two;
    ...
    cks = *(volatile uint16_t*)0x4000A708;
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "CKS BE result is %04x, %04x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 184, cks, (uint16_t)~checksum); } } while (0 == 1); }


     ;
    if (cks == ((uint16_t)~checksum)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Success %04X Checksum=====\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 189, cks); } } while (0 == 1); };
    } else {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Failed %04X Checksum======\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 191, cks); } } while (0 == 1); };
    }
}
...
static void _cb_cmd(void *arg)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "[DMA] [TEST] Callback is working, arg is %p\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 200, arg); } } while (0 == 1); };
    first->arg = 
# 201 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 3 4
                ((void *)0)
# 201 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c"
                    ;
}
...
static void _bl_cks_test_case5()
{
    ...
    second.cb = 
# 248 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 3 4
               ((void *)0)
# 248 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c"
                   ;
    second.arg = 
# 249 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 3 4
                ((void *)0)
# 249 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c"
                    ;
    ...
    last.cb = 
# 263 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 3 4
             ((void *)0)
# 263 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c"
                 ;
    last.arg = 
# 264 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c" 3 4
              ((void *)0)
# 264 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_cks.c"
                  ;
    ...
    if (0x6DF1 == cks_result) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Success %04X Checksum=====\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 274, cks_result); } } while (0 == 1); };
    } else {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "====== Failed %04X Checksum======\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 276, cks_result); } } while (0 == 1); };
    }
}

int bl_cks_test(void)
{
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "--->>> case1 test\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 282); } } while (0 == 1); };
    _bl_cks_test_case1();
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "--->>> case2 test\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 284); } } while (0 == 1); };
    _bl_cks_test_case2();
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "--->>> case3 test\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 286); } } while (0 == 1); };
    _bl_cks_test_case3();
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "--->>> case4 test\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 288); } } while (0 == 1); };
    _bl_cks_test_case4();
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_cks)) { bl_printk("%s (%d)[%s:%4d] " "--->>> case5 test\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_cks.c", 290); } } while (0 == 1); };
    _bl_cks_test_case5();
    return 0;
}
