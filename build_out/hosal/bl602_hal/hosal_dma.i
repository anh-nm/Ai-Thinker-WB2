# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c"
...
# 21 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_dma.h"
...
# 22 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_dma.h" 2
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c" 2
...
# 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c" 2
...
# 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c" 2
...
# 13 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c" 2
...
# 14 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalhosal_dma;
    const blog_info_t _fsymf_info_hosalhosal_dma __attribute__((used, section(".static_blogfile_code." "hosalhosal_dma"))) = { (blog_level_t *)(&_fsymf_level_hosalhosal_dma), (char *)("hosal.hosal_dma")};
...
# 15 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c" 2

static hosal_dma_dev_t *gp_hosal_dma_dev = 
# 16 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c" 3 4
                                          ((void *)0)
# 16 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c"
                                              ;
...
int hosal_dma_init(void)
{
    ...
    if (gp_hosal_dma_dev == 
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c" 3 4
                           ((void *)0)
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c"
                               ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "no memory !!!\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 84); } } while (0 == 1); };
    }

    gp_hosal_dma_dev->max_chans = DMA_CH_MAX;
    gp_hosal_dma_dev->used_chan = calloc(sizeof(struct hosal_dma_chan) * DMA_CH_MAX, 1);
    if (gp_hosal_dma_dev->used_chan == 
# 89 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c" 3 4
                                      ((void *)0)
# 89 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c"
                                          ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "no memory !!!\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 90); } } while (0 == 1); };
    }
    DMA_Enable();
...
hosal_dma_chan_t hosal_dma_chan_request(int flag)
{
    ...
    if (!gp_hosal_dma_dev) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 114); } } while (0 == 1); };
        return -1;
    }
...
# 134 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c"
int hosal_dma_chan_release(hosal_dma_chan_t chan)
{
    if (!gp_hosal_dma_dev) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 137); } } while (0 == 1); };
        return -1;
    }
    ...
    gp_hosal_dma_dev->used_chan[chan].callback = 
# 146 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c" 3 4
                                                ((void *)0)
# 146 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c"
                                                    ;
    DMA_IntMask(chan, DMA_INT_TCOMPLETED, MASK);
    DMA_IntMask(chan, DMA_INT_ERR, MASK);
    return 0;
}
# 159 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c"
int hosal_dma_chan_start(hosal_dma_chan_t chan)
{
    if (!gp_hosal_dma_dev) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 162); } } while (0 == 1); };
        return -1;
    }
...
# 177 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c"
int hosal_dma_chan_stop(hosal_dma_chan_t chan)
{
    if (!gp_hosal_dma_dev) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 180); } } while (0 == 1); };
        return -1;
    }
...
# 198 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c"
int hosal_dma_irq_callback_set(hosal_dma_chan_t chan, hosal_dma_irq_t pfn, void *p_arg)
{
    if (!gp_hosal_dma_dev) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 201); } } while (0 == 1); };
        return -1;
    }
    if (chan > gp_hosal_dma_dev->max_chans) {
        return -1;
...
# 223 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_dma.c"
int hosal_dma_finalize(void)
{
    if (!gp_hosal_dma_dev) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_dma)) { bl_printk("%s (%d)[%s:%4d] " "please hosal_dma_init !\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_dma.c", 226); } } while (0 == 1); };
        return -1;
    }
