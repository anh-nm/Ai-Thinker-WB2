...
_irq_num_check:
.LFB14:
	.file 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
	.loc 1 87 1
	.cfi_startproc
.LVL0:
	.loc 1 88 5
...
.L22:
	...
	.loc 1 71 244 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL18:
	.loc 1 71 144 discriminator 5
	beq	a0,zero,.L24
	.loc 1 71 273 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL19:
.L28:
...
.LVL26:
.L24:
	.loc 1 71 304 is_stmt 0 discriminator 8
	call	xTaskGetTickCount
.LVL27:
	j	.L28
.L17:
...
.LVL30:
	...
	.loc 1 100 252 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL31:
	.loc 1 100 148 discriminator 5
	beq	a0,zero,.L35
	.loc 1 100 281 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL32:
.L50:
...
.LVL33:
.L32:
	.loc 1 100 395 is_stmt 1 discriminator 11
...
.L37:
	...
	.loc 1 107 246 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL34:
	.loc 1 107 150 discriminator 5
	beq	a0,zero,.L40
	.loc 1 107 275 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL35:
.L51:
...
.L58:
	...
	.loc 1 160 279 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL66:
	.loc 1 160 148 discriminator 5
	beq	a0,zero,.L61
	.loc 1 160 308 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL67:
.L68:
	.loc 1 160 339 discriminator 8
	mv	a2,a0
...
.L60:
.L66:
	.loc 1 160 431 is_stmt 1 discriminator 1
	...
	j	.L66
.L61:
	.loc 1 160 339 is_stmt 0 discriminator 8
	call	xTaskGetTickCount
.LVL69:
	j	.L68
	.cfi_endproc
...
.LVL90:
	...
	.loc 1 360 255 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL91:
	.loc 1 360 148 discriminator 5
	beq	a0,zero,.L106
	.loc 1 360 284 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL92:
.L138:
	.loc 1 360 315 discriminator 8
	mv	a2,a0
...
.LVL93:
.L105:
	.loc 1 360 386 is_stmt 1 discriminator 11
...
.LBB27:
.LBB17:
	.loc 1 324 293 is_stmt 0
	call	xTaskGetTickCount
.LVL101:
	j	.L132
.L76:
	.loc 1 326 142 is_stmt 1
	.loc 1 326 233 is_stmt 0
	call	xPortIsInsideInterrupt
.LVL102:
	.loc 1 326 142
	beq	a0,zero,.L82
...
.LBB31:
 ...
 #APP
# 385 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 1
	add sp, x0, s0
# 0 "" 2
...
.LFB24:
	...
	li	a0,8
 #APP
# 413 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 1
	csrrc a0, mstatus, a0
# 0 "" 2
.LVL143:
	.loc 1 414 5
...
.LVL144:
	.loc 1 419 5
 #APP
# 419 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 1
	csrw mstatus, a0
# 0 "" 2
...
.Letext0:
	...
	.file 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.h"
	...
	.file 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/coredump/inc/bl_coredump.h"
	...
	.file 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic.h"
	.file 13 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_wdt.h"
	.file 14 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_glb.h"
...
.LASF23:
	.string	"blog_info_t"
.LASF113:
	.string	"/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
.LASF103:
