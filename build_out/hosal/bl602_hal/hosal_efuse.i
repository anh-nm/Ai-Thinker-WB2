# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_efuse.c"
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalhosal_efuse;
    const blog_info_t _fsymf_info_hosalhosal_efuse __attribute__((used, section(".static_blogfile_code." "hosalhosal_efuse"))) = { (blog_level_t *)(&_fsymf_level_hosalhosal_efuse), (char *)("hosal.hosal_efuse")};
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_efuse.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_efuse.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_efuse.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_efuse.h" 1
# 20 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_efuse.h"
int hosal_efuse_read(uint32_t addr, uint32_t *data, uint32_t len);
# 33 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/include/hosal_efuse.h"
int hosal_efuse_write(uint32_t addr, uint32_t *data, uint32_t len);
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_efuse.c" 2

int hosal_efuse_read(uint32_t addr, uint32_t *data, uint32_t len)
{

    if (addr % 4 || (uint32_t)data % 4) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_efuse)) { bl_printk("%s (%d)[%s:%4d] " "parameter error!\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_efuse.c", 10); } } while (0 == 1); };
        return -1;
    }
...
int hosal_efuse_write(uint32_t addr, uint32_t *data, uint32_t len)
{
    ...
    if (addr % 4 || (uint32_t)data % 4) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_efuse)) { bl_printk("%s (%d)[%s:%4d] " "parameter error!\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_efuse.c", 25); } } while (0 == 1); };
        return -1;
    }
