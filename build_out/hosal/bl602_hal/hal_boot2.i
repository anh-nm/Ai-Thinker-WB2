# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 2

# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_boot2.h" 1
# 39 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_boot2.h"
...
# 40 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_boot2.h" 2
...
BL_Err_Type SFlash_Write_Reg_With_Cmd(SPI_Flash_Cfg_Type *flashCfg,uint8_t writeRegCmd,uint8_t *regValue,
                                      uint8_t regLen);
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_boot2.h" 2
...
# 42 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_boot2.h" 2
# 58 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_boot2.h"
typedef enum {
    PT_ERROR_SUCCESS,
...
# 163 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_boot2.h"
...
PtTable_Error_Type PtTable_Get_Active_Entries_By_Name(PtTable_Stuff_Config *ptStuff,
                                                    uint8_t *name,
                                                    PtTable_Entry_Config *ptEntry);
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 2
...
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 2
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalhal_boot2;
    const blog_info_t _fsymf_info_hosalhal_boot2 __attribute__((used, section(".static_blogfile_code." "hosalhal_boot2"))) = { (blog_level_t *)(&_fsymf_level_hosalhal_boot2), (char *)("hosal.hal_boot2")};
...
# 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 2
# 22 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
static struct {
...
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 3 4
                              ((void *)0)
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
...
static void _dump_partition(void)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "======= PtTable_Config @%p=======\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 53, part); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "magicCode 0x%08X;""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 54, (unsigned int)(part->ptTable.magicCode)); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk(" version 0x%04X;""\x1b[0m" "\r\n", part->ptTable.version); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk(" entryCnt %u;""\x1b[0m" "\r\n", part->ptTable.entryCnt); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk(" age %lu;""\x1b[0m" "\r\n", part->ptTable.age); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk(" crc32 0x%08X\r\n""\x1b[0m" "\r\n", (unsigned int)part->ptTable.crc32); } } while (0 == 1); };

    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "idx  type device activeIndex     name   Address[0]  Address[1]  Length[0]   Length[1]   age\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 60); } } while (0 == 1); };
    for (i = 0; i < part->ptTable.entryCnt; i++) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "[%02d] ""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 62, i); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk(" %02u""\x1b[0m" "\r\n", part->ptEntries[i].type); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("     %u""\x1b[0m" "\r\n", part->ptEntries[i].device); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("         %u""\x1b[0m" "\r\n", part->ptEntries[i].activeIndex); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("      %8s""\x1b[0m" "\r\n", part->ptEntries[i].name); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("  %p""\x1b[0m" "\r\n", (void*)(part->ptEntries[i].Address[0])); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("  %p""\x1b[0m" "\r\n", (void*)(part->ptEntries[i].Address[1])); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("  %p""\x1b[0m" "\r\n", (void*)(part->ptEntries[i].maxLen[0])); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("  %p""\x1b[0m" "\r\n", (void*)(part->ptEntries[i].maxLen[1])); } } while (0 == 1); };
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("  %lu\r\n""\x1b[0m" "\r\n", (part->ptEntries[i].age)); } } while (0 == 1); };
    }
}
...
int hal_boot2_partition_bus_addr(const char *name, uint32_t *addr0, uint32_t *addr1, uint32_t *size0, uint32_t *size1, int *active)
{
    ...
    if ((0x54504642) != boot2_partition_table.table.ptTable.magicCode) {
        return -
# 90 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               5
# 90 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
                  ;
    }
    ...
    if (boot2_partition_table.table.ptTable.entryCnt == i) {
        return -
# 100 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               2
# 100 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
                     ;
    }
    ...
    *size1 = boot2_partition_table.table.ptEntries[i].maxLen[1];
    ...
    if (boot2_partition_table.table.ptTable.entryCnt == i) {
        return -
# 115 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               140
# 115 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
                        ;
    }
    ...
    if ( (addr0_t && (addr0_t < boot2_partition_table.table.ptEntries[i].Address[0])) ||
        ...
        return -
# 122 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               22
# 122 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
                     ;
    }
    if ((0 != boot2_partition_table.table.ptEntries[i].activeIndex) &&
        (1 != boot2_partition_table.table.ptEntries[i].activeIndex)) {
        return -
# 126 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               14
# 126 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
                     ;
    }
...
int hal_boot2_partition_addr(const char *name, uint32_t *addr0, uint32_t *addr1, uint32_t *size0, uint32_t *size1, int *active)
{
    ...
    if ((0x54504642) != boot2_partition_table.table.ptTable.magicCode) {
        return -
# 169 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               5
# 169 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
                  ;
    }
    ...
    if (boot2_partition_table.table.ptTable.entryCnt == i) {
        return -
# 179 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 3
               2
# 179 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
                     ;
    }
...
int hal_boot2_init(void)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "[HAL] [BOOT2] Active Partition[%u] consumed %d Bytes\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 253, boot2_partition_table.partition_active_idx, sizeof(PtTable_Stuff_Config)); } } while (0 == 1); }
...
void hal_update_mfg_ptable(void)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "update mfg table.\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 270); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "====================\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 271); } } while (0 == 1); };
    if (0 == hal_boot2_get_active_entries_byname((uint8_t *)"FW", (HALPartition_Entry_Config *)(&ptEntry_fw))) {
        if (0 == hal_boot2_get_active_entries_byname((uint8_t *)"mfg", (HALPartition_Entry_Config *)(&ptEntry_media))) {
            if (ptEntry_fw.Address[1] == ptEntry_media.Address[0]) {

                memset(ptEntry_media.name, 0, sizeof(ptEntry_media.name));
                PtTable_Update_Entry(
# 277 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c" 3 4
                                    ((void *)0)
# 277 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_boot2.c"
                                        , !boot2_partition_table.partition_active_idx, &boot2_partition_table.table, &ptEntry_media);

                if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "===== update mfg partition =====\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 279); } } while (0 == 1); };
            }
        }
    }

    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "====================\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 284); } } while (0 == 1); };
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_boot2)) { bl_printk("%s (%d)[%s:%4d] " "update mfg table.\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_boot2.c", 285); } } while (0 == 1); };
}
