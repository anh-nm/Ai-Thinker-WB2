# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sec_eng.h" 1
# 40 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_sec_eng.h"
...
void SEC_Eng_Turn_Off_Sec_Ring(void);
              ;
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt.h" 1
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt.h" 2

# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt_port.h" 1
# 33 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt_port.h"

# 33 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt_port.h"
typedef struct tag_bflb_crypt_cfg_t
{
# 45 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt_port.h"
    uint8_t type;
}bflb_crypt_cfg_t;
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt.h" 2
# 28 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/cipher_suite/inc/bflb_crypt.h"
...
# 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalbl_sec_aes;
    const blog_info_t _fsymf_info_hosalbl_sec_aes __attribute__((used, section(".static_blogfile_code." "hosalbl_sec_aes"))) = { (blog_level_t *)(&_fsymf_level_hosalbl_sec_aes), (char *)("hosal.bl_sec_aes")};
...
# 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 2
...
static void Aes_Compare_Data(const uint8_t *expected, uint8_t *input, uint32_t len)
{
    ...
    for (i = 0; i < len; i++) {
        if (input[i] != expected[i]) {
            is_failed = 1;
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "%s[%02d], %02x %02x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 28, input[i] ==expected[i] ? "S" : "F", i, input[i], expected[i]); } } while (0 == 1); }
    ...
    if (is_failed) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "====== Failed %lu Bytes======\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 37, len); } } while (0 == 1); };
    } else {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "====== Success %lu Bytes=====\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 39, len); } } while (0 == 1); };
    }
}
...
void Sec_Eng_AES_Link_Case_CBC_128(SEC_ENG_AES_ID_Type aesId)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "[CBC] IV Status Initial, %08lx\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 106, linkCfg.aesSrcAddr); } } while (0 == 1); };
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "[CBC] IV Status After, %08lx\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 110, linkCfg.aesSrcAddr); } } while (0 == 1); };
    _dump_iv_status(&linkCfg);
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "[CBC] IV Status After %08lx\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 115, linkCfg.aesSrcAddr); } } while (0 == 1); };
    _dump_iv_status(&linkCfg);
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "[CBC] IV Status After, %08lx\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 120, linkCfg.aesSrcAddr); } } while (0 == 1); };
    _dump_iv_status(&linkCfg);
...
void Sec_Eng_AES_Link_Case_CTR_128(SEC_ENG_AES_ID_Type aesId)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "[CTR] IV Status Initial, %08lx\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 164, linkCfg.aesSrcAddr); } } while (0 == 1); };
    _dump_iv_status(&linkCfg);

    Sec_Eng_AES_Link_Work(aesId, (uint32_t)&linkCfg, &(aesSrcBuf_data[0]), 32, aesDstBuf);
    Aes_Compare_Data(aesResult_entrypted_ctr_128, (uint8_t*)linkCfg.aesDstAddr, 32);

    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "[CTR] IV Status After %08lx\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 170, linkCfg.aesSrcAddr); } } while (0 == 1); };
    _dump_iv_status(&linkCfg);

    Sec_Eng_AES_Link_Work(aesId, (uint32_t)&linkCfg, &(aesSrcBuf_data[0]) + 32, 16, aesDstBuf);
    Aes_Compare_Data(&(aesResult_entrypted_ctr_128[0]) + 32, (uint8_t*)linkCfg.aesDstAddr, 16);
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "[CTR] IV Status After %08lx\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 175, linkCfg.aesSrcAddr); } } while (0 == 1); };
    _dump_iv_status(&linkCfg);

    Sec_Eng_AES_Link_Work(aesId, (uint32_t)&linkCfg, &(aesSrcBuf_data[0]) + 48, 16, aesDstBuf);
    Aes_Compare_Data(&(aesResult_entrypted_ctr_128[0]) + 48, (uint8_t*)linkCfg.aesDstAddr, 16);
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec_aes)) { bl_printk("%s (%d)[%s:%4d] " "[CTR] IV Status After, %08lx\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec_aes.c", 180, linkCfg.aesSrcAddr); } } while (0 == 1); };
    _dump_iv_status(&linkCfg);
...
# 330 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c"
    b[0] = 0;
    b[0] |= ( add_len > 0 ) << 6;
    b[0] |= ( ( tag_len - 2 ) / 2 ) << 3;
    b[0] |= q - 1;
    ...
    if( add_len > 0 )
    {
        ...
        BL602_MemSet( b, 0, 16 );
# 378 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c"
        cbc_adata_round = 1;
                         ...
                         const unsigned char *input, unsigned char *output, unsigned char *tag, size_t tag_len)
{
 ...
 unsigned char *b_input = 
# 557 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 3 4
                         ((void *)0)
# 557 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c"
                             ;
 unsigned char *b_output = 
# 558 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 3 4
                          ((void *)0)
# 558 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c"
                              ;
 int ret = 0;
 ...
 bflb_crypt_init(&crypt_handle, 1);
    bflb_crypt_setkey(&crypt_handle, key, get_key_type(key_bytelen), key_bytelen, cbc_iv, 16, 1);
    if(bflb_crypt_encrypt(&crypt_handle, b_input, cbc_length, 0, b_output) != 0)
 {
  ret = -1;
  goto exit;
 }
 ...
 BL602_MemSet(b_output, 0, b_output_size);
    ...
    bflb_crypt_init(&crypt_handle, 2);
 bflb_crypt_setkey(&crypt_handle, key, get_key_type(key_bytelen), key_bytelen, ctr_iv, 16, 1);
 if(bflb_crypt_encrypt(&crypt_handle, b_input, ctr_length, 0, b_output) != 0)
 {
     ret = -1;
  goto exit;
 }
...
exit:
 ...
 unsigned int ctr_length = 0;
    ...
    unsigned int b_output_size = 0;
    unsigned char *b_input = 
# 648 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 3 4
                             ((void *)0)
# 648 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c"
                                 ;
    unsigned char *b_output = 
# 649 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c" 3 4
                             ((void *)0)
# 649 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec_aes.c"
                                 ;
    int ret = 0;
...
int bl_sec_aes_ecb_encrypt(const uint8_t *key, unsigned int key_bytelen, size_t length, const unsigned char *input, unsigned char *output)
{
     ...
     bflb_crypt_init(&crypt_handle, 0);
     bflb_crypt_setkey(&crypt_handle, key, get_key_type(key_bytelen), key_bytelen, decrypt_iv, 16, 1);

     if(bflb_crypt_encrypt(&crypt_handle, input, length, 0, output) != 0)
         return -1;
     return 0;
}
...
int bl_sec_aes_ecb_decrypt(const uint8_t *key, unsigned int key_bytelen, size_t length, const unsigned char *input, unsigned char *output)
{
     uint8_t decrypt_iv[16]={0};
     bflb_crypt_init(&crypt_handle, 0);
     bflb_crypt_setkey(&crypt_handle, key, get_key_type(key_bytelen), key_bytelen, decrypt_iv, 16, 2);
