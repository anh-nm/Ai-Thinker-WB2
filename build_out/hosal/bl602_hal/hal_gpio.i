# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalhal_gpio;
    const blog_info_t _fsymf_info_hosalhal_gpio __attribute__((used, section(".static_blogfile_code." "hosalhal_gpio"))) = { (blog_level_t *)(&_fsymf_level_hosalhal_gpio), (char *)("hosal.hal_gpio")};
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 2
...
static int _get_gpio_max(const void* fdt, uint32_t dtb_offset)
{
    ...
    if (
# 48 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
       ((void *)0) 
# 48 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c"
            == addr_prop) {
        return -1;
    }
...
static int _get_gpio_config(const void* fdt, uint32_t dtb_offset, const char *name, struct gpio_feature_config *gpio_config)
{
    ...
    const uint32_t *addr_prop = 0;
    const char *result = 0;
# 73 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c"
    offset1 = fdt_subnode_offset(fdt, dtb_offset, name);
    if (offset1 < 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s NOT found\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 75, name); } } while (0 == 1); };
        return -1;
    }
    ...
    if ((lentmp != 4) || (memcmp("okay", result, 4) != 0)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "[%s] status = %s\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 84, name, result); } } while (0 == 1); };
        return 0;
    }

    addr_prop = fdt_getprop(fdt, offset1, "pin", &lentmp);
    if (addr_prop == 
# 89 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
                    ((void *)0)
# 89 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c"
                        ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "no pin found for %s\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 90, name); } } while (0 == 1); };
        return 0;
    }
    ...
    if (3 == lentmp && memcmp("led", result, 3) == 0) {
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s: unvalid GPIO config %3s\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 99, name, result); } } while (0 == 1); };
        return 0;
    }
    ...
    if (2 == lentmp && memcmp("Hi", result, 2) == 0) {
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s: unvalid GPIO config %3s\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 109, name, result); } } while (0 == 1); };
        return 0;
    }
    ...
    if (5 == lentmp && memcmp("blink", result, 5) == 0) {
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s: unvalid GPIO config %3s\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 121, name, result); } } while (0 == 1); };
        return 0;
    }

    addr_prop = fdt_getprop(fdt, offset1, "time", &lentmp);
    if (addr_prop == 
# 126 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
                    ((void *)0)
# 126 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c"
                        ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s: unvalid GPIO config\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 127, name); } } while (0 == 1); };
        return 0;
    }
...
{
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "New CONF: GPIO%02u: feature %u, active %u, mode %u, time %u\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 140, config->pin, config->feature, config->active, config->mode, config->time); } } while (0 == 1); }
...
int hal_gpio_init_from_dts(uint32_t fdt, uint32_t dtb_offset)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "[HAL] [GPIO] Max num is %d\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 171, num); } } while (0 == 1); };
    ...
    for (i = 0; i < num; i++) {
        ...
        if (_get_gpio_config((const void*)fdt, dtb_offset, node, &gpio_config) < 0) {
            ...
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "%s: unvalid GPIO config\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 185, node); } } while (0 == 1); };
        }
    }
...
# 192 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
                                 ((void *)0)
# 192 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c"
                                     ;
int hal_gpio_register_handler(void *func, int gpioPin, int intCtrlMod, int intTrgMod, void *arg)
{
    if (
# 195 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
       ((void *)0) 
# 195 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c"
            == func || gpioPin > 31 || intCtrlMod > 1 || intTrgMod > 3) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "register paraments is not correct! \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 196); } } while (0 == 1); };
        return -1;
    }
    ...
    if (!pstnode) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhal_gpio)) { bl_printk("%s (%d)[%s:%4d] " "Malloc failed \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hal_gpio.c", 204); } } while (0 == 1); };
        return -1;
    }
    ...
    if (!pstgpio_head) {
        ...
        pstnode->next = 
# 216 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c" 3 4
                       ((void *)0)
# 216 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hal_gpio.c"
                           ;
    }
    else {
