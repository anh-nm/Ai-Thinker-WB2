...
cmd_gpio_get:
.LFB6:
	.file 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_gpio_cli.c"
	.loc 1 65 1
	.cfi_startproc
.LVL0:
	.loc 1 66 5
	...
	.loc 1 71 257 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL1:
	.loc 1 71 153 discriminator 5
	beq	a0,zero,.L4
	.loc 1 71 286 discriminator 7
...
.LVL15:
	...
	.loc 1 82 235 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL16:
	.loc 1 82 149 discriminator 5
	beq	a0,zero,.L7
	.loc 1 82 264 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL17:
.L15:
	.loc 1 82 295 discriminator 8
	mv	a2,a0
	.loc 1 82 149 discriminator 8
	bne	s2,zero,.L11
	.loc 1 82 370 discriminator 11
	lbu	a5,15(sp)
	bne	a5,zero,.L12
	.loc 1 82 370
	lui	a6,%hi(.LC2)
...
.L9:
	...
	call	bl_printk
.LVL18:
	.loc 1 82 399 is_stmt 1 discriminator 18
...
.LVL21:
	...
	.loc 1 46 268 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL22:
	.loc 1 46 153 discriminator 5
	beq	a0,zero,.L21
	.loc 1 46 297 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL23:
.L33:
...
.L23:
	...
	.loc 1 54 237 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL33:
	.loc 1 54 155 discriminator 5
	beq	a0,zero,.L25
	.loc 1 54 266 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL34:
.L34:
	.loc 1 62 1 discriminator 8
...
.L24:
	...
	.loc 1 57 238 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL39:
	.loc 1 57 149 discriminator 5
	beq	a0,zero,.L28
	.loc 1 57 267 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL40:
.L35:
	.loc 1 57 298 discriminator 8
	mv	a2,a0
...
.LVL41:
.L27:
	.loc 1 57 380 is_stmt 1 discriminator 15
...
.LVL47:
	...
	.loc 1 15 278 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL48:
	.loc 1 15 153 discriminator 5
	beq	a0,zero,.L41
	.loc 1 15 307 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL49:
.L58:
...
.L43:
	...
	.loc 1 25 237 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL65:
	.loc 1 25 155 discriminator 5
	beq	a0,zero,.L45
	.loc 1 25 266 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL66:
.L59:
	.loc 1 39 1 discriminator 8
...
.L44:
	...
	.loc 1 28 262 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL73:
	.loc 1 28 149 discriminator 5
	beq	a0,zero,.L48
	.loc 1 28 291 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL74:
.L60:
	.loc 1 28 322 discriminator 8
	mv	a2,a0
...
.LVL75:
.L47:
	.loc 1 28 473 is_stmt 1 discriminator 23
...
.Letext0:
	...
	.file 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/cli/cli/include/cli.h"
	...
	.file 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_gpio.h"
...
.LASF34:
	.string	"cmds_user"
.LASF55:
	.string	"/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_gpio_cli.c"
.LASF46:
	.string	"bl_printk"
.LASF20:
