# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalbl_irq;
    const blog_info_t _fsymf_info_hosalbl_irq __attribute__((used, section(".static_blogfile_code." "hosalbl_irq"))) = { (blog_level_t *)(&_fsymf_level_hosalbl_irq), (char *)("hosal.bl_irq")};
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/platform_print/platform_gpio.h" 1
...
# 277 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_uart.h"
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/platform_print/platform_gpio.h" 2
...
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/platform_print/platform_gpio.h" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_gpio.h" 1
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/platform_print/platform_gpio.h" 2
# 32 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Common/platform_print/platform_gpio.h"
void bflb_platform_init_uart_debug_gpio(void);
void bflb_platform_deinit_uart_debug_gpio(void);
# 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/freertos_riscv_ram/panic/panic.h" 1
...
# 11 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_wdt.h" 1


int bl_wdt_init(int ms);
void bl_wdt_feed(void);
void bl_wdt_disable(void);
# 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 2


# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/coredump/inc/bl_coredump.h" 1
...
# 15 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 2
...
void bl_irq_exception_trigger(BL_IRQ_EXCEPTION_TYPE_T type, void *ptr)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "Trigger exception val is %08lx\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 71, val); } } while (0 == 1); };
}
...
static inline void _irq_num_check(int irqnum)
{
    if (irqnum < 0 || irqnum >= sizeof(handler_list[0])/sizeof(handler_list[0][0])) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "illegal irqnum %d\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 89, irqnum); } } while (0 == 1); };
        while (1) {
...
void bl_irq_register_with_ctx(int irqnum, void *handler, void *ctx)
{
    ...
    if (handler_list[0][irqnum] && handler_list[0][irqnum] != handler) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_WARN >= _fsymc_level_hosal) && (BLOG_LEVEL_WARN >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "IRQ %d already registered with %p \r\n""\x1b[0m" "\r\n", "\x1b[33mWARN", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 100, irqnum, handler_list[0][irqnum]); } } while (0 == 1); }
    ...
    if (handler == 
# 106 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
                  ((void *)0)
# 106 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
                      ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "handler is NULL pointer! \r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 107); } } while (0 == 1); };
        return;
    }

    if (
# 111 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
       ((void *)0) 
# 111 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
            == ctx) {
        handler_list[0][irqnum] = handler;
        handler_list[1][irqnum] = 
# 113 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
                                 ((void *)0)
# 113 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
                                     ;
    }
    else {
        handler_list[0][irqnum] = handler;
...
# 134 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
                                             ((void *)0)
# 134 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
                                                 );
}
...
# 142 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
                             ((void *)0)
# 142 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
                                 ;
}
...
{
    void *handler = 
# 147 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c" 3 4
                   ((void *)0)
# 147 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
                       ;
    mcause &= 0x7FFFFFF;
    ...
    if (handler) {
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "Cannot handle mcause 0x%lx:%lu, adjust to externel(0x%lx:%lu)\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 160, mcause, mcause, mcause - 16, mcause - 16); } } while (0 == 1); }
...
{
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "Exception code: %lu\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 174, code); } } while (0 == 1); };
    switch (code) {
        case 0x00:
...
# 288 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
static void registerdump(unsigned int *regs)
{
# 324 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_irq.c"
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "Current task sp data:\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 324); } } while (0 == 1); };

  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "RA:%08x, mstatus:%08x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 326, regs[1], regs[29]); } } while (0 == 1); }
                                          ;

  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "A0:%08x A1:%08x A2:%08x A3:%08x A4:%08x A5:%08x " "A6:%08x A7:%08x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 329, regs[7], regs[8], regs[9], regs[10], regs[11], regs[13], regs[13], regs[14]); } } while (0 == 1); }


                                                                 ;
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "T0:%08x T1:%08x T2:%08x T3:%08x T4:%08x T5:%08x T6:%08x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 333, regs[2], regs[3], regs[4], regs[25], regs[26], regs[27], regs[28]); } } while (0 == 1); }

                                                   ;
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "S0:%08x S1:%08x S2:%08x S3:%08x S4:%08x S5:%08x " "S6:%08x S7:%08x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 336, regs[5], regs[6], regs[15], regs[16], regs[17], regs[18], regs[19], regs[20]); } } while (0 == 1); }


                                                                 ;
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "S8:%08x S9:%08x S10:%08x S11:%08x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 340, regs[21], regs[22], regs[23], regs[24]); } } while (0 == 1); }
                                                                   ;
}
...
void exception_entry(uint32_t mcause, uint32_t mepc, uint32_t mtval, uintptr_t *regs, uintptr_t *tasksp)
{
    ...
    if ((mcause & 0x3ff) == 4){
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_irq)) { bl_printk("%s (%d)[%s:%4d] " "mcause %08lx, mepc %08lx, mtval %08lx\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_irq.c", 360, mcause, mepc, mtval); } } while (0 == 1); }
