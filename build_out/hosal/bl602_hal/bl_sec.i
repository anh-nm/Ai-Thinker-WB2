# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
void SEC_Eng_Turn_Off_Sec_Ring(void);
              ;
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
# 512 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalbl_sec;
    const blog_info_t _fsymf_info_hosalbl_sec __attribute__((used, section(".static_blogfile_code." "hosalbl_sec"))) = { (blog_level_t *)(&_fsymf_level_hosalbl_sec), (char *)("hosal.bl_sec")};
...
# 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec.c" 2




static uint8_t trng_buffer[(32)];
...
static void RSA_Compare_Data(const uint8_t *expected, const uint8_t *input, uint32_t len)
{
    ...
    for (i = 0; i < len; i++) {
        if (input[i] != expected[i]) {
            is_failed = 1;
            if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec)) { bl_printk("%s (%d)[%s:%4d] " "%s[%02d], %02x %02x\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec.c", 122, input[i] ==expected[i] ? "S" : "F", i, input[i], expected[i]); } } while (0 == 1); }
    ...
    if (is_failed) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_sec)) { bl_printk("%s (%d)[%s:%4d] " "====== Failed %lu Bytes======\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec.c", 131, len); } } while (0 == 1); };
    } else {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_sec)) { bl_printk("%s (%d)[%s:%4d] " "====== Success %lu Bytes=====\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_sec.c", 133, len); } } while (0 == 1); };
    }
}
...
# 422 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_sec.c"
