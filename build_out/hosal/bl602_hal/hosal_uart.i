# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c"
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c" 2
...
# 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c" 2
...
# 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c" 2
...
# 13 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c" 2
...
# 14 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c" 2
...
# 15 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalhosal_uart;
    const blog_info_t _fsymf_info_hosalhosal_uart __attribute__((used, section(".static_blogfile_code." "hosalhosal_uart"))) = { (blog_level_t *)(&_fsymf_level_hosalhosal_uart), (char *)("hosal.hosal_uart")};
...
# 16 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c" 2

static const uint32_t g_uart_addr[2] = {((uint32_t)0x4000A000), ((uint32_t)0x4000A100)};
...
static void __uart_rx_dma_irq(void *p_arg, uint32_t flag)
{
    ...
    if (flag != 0) {
     if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_uart)) { bl_printk("%s (%d)[%s:%4d] " "DMA RX TRANS ERROR\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_uart.c", 110); } } while (0 == 1); };
    }
...
static void __uart_tx_dma_irq(void *p_arg, uint32_t flag)
{
    ...
    if (flag != 0) {
     if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_uart)) { bl_printk("%s (%d)[%s:%4d] " "DMA TX TRANS ERROR\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_uart.c", 123); } } while (0 == 1); };
    }
...
{
 if (dma_cfg->dma_buf == 
# 133 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c" 3 4
                        ((void *)0) 
# 133 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c"
                             || dma_cfg->dma_buf_size == 0) {
  return -1;
 }
 DMA_Channel_Cfg_Type txchCfg = {
     (uint32_t)dma_cfg->dma_buf,
  g_uart_addr[uart->port] + (0x88),
 ...
 if (uart->dma_tx_chan < 0) {
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_uart)) { bl_printk("%s (%d)[%s:%4d] " "dma_tx_chan request failed !\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_uart.c", 167); } } while (0 == 1); };
  return -1;
 }
...
{
 if (dma_cfg->dma_buf == 
# 187 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c" 3 4
                        ((void *)0) 
# 187 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c"
                             || dma_cfg->dma_buf_size == 0) {
  return -1;
 }

 DMA_Channel_Cfg_Type rxchCfg = {
  g_uart_addr[uart->port] + (0x8C),
  (uint32_t)dma_cfg->dma_buf,
  dma_cfg->dma_buf_size,
     DMA_TRNS_P2M,
  DMA_CH0,
 ...
 if (uart->dma_rx_chan < 0) {
  if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_uart)) { bl_printk("%s (%d)[%s:%4d] " "dma_rx_chan request failed !\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_uart.c", 222); } } while (0 == 1); };
  return -1;
 }
...
int hosal_uart_abr_get(hosal_uart_dev_t *uart, uint8_t mode)
{
    ...
    if (uart == 
# 309 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c" 3 4
               ((void *)0)
# 309 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/hosal_uart.c"
                   ) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalhosal_uart)) { bl_printk("%s (%d)[%s:%4d] " "param is error !\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "hosal_uart.c", 310); } } while (0 == 1); };
        return -1;
    }
