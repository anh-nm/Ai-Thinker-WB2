# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.c" 2
...
# 39 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/pwm_reg.h"
...
# 40 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/Device/Bouffalo/BL602/Peripherals/pwm_reg.h" 2
...
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/soc/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_pwm.h" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.c" 2

# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.h" 1
# 10 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.h"
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.c" 2
...
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalbl_pwm;
    const blog_info_t _fsymf_info_hosalbl_pwm __attribute__((used, section(".static_blogfile_code." "hosalbl_pwm"))) = { (blog_level_t *)(&_fsymf_level_hosalbl_pwm), (char *)("hosal.bl_pwm")};
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.c" 2
...
int32_t bl_pwm_init(uint8_t id, uint8_t pin, uint32_t freq)
{
    ...
    if ((freq < 2000) || (freq > 800000)) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_pwm)) { bl_printk("%s (%d)[%s:%4d] " "arg error. bl_pwm_init freq = %ld\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_pwm.c", 60, freq); } } while (0 == 1); };
        return -1;
    }
...
int32_t bl_pwm_get_duty(uint8_t id, float *p_duty)
{
    ...
    if (
# 119 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.c" 3 4
       ((void *)0) 
# 119 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_pwm.c"
            == p_duty) {
        return -1;
    }
    PWM_Channel_Get(id, &period, &threshold1, &threshold2);
