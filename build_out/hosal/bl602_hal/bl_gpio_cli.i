# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_gpio_cli.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_gpio_cli.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_gpio_cli.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_gpio_cli.c" 2
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_gpio_cli.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalbl_gpio_cli;
    const blog_info_t _fsymf_info_hosalbl_gpio_cli __attribute__((used, section(".static_blogfile_code." "hosalbl_gpio_cli"))) = { (blog_level_t *)(&_fsymf_level_hosalbl_gpio_cli), (char *)("hosal.bl_gpio_cli")};
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_gpio_cli.c" 2
...
static void cmd_gpio_func(char *buf, int len, int argc, char **argv)
{
    ...
    if (5 != argc) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_gpio_cli)) { bl_printk("%s (%d)[%s:%4d] " "Usage: %s 24 1 1 0\r\n  set GPIO24 to input with pullup\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_gpio_cli.c", 15, argv[0]); } } while (0 == 1); }
    ...
    if (ionum < 0 || inputmode < 0 || pullup < 0 || pulldown < 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_gpio_cli)) { bl_printk("%s (%d)[%s:%4d] " "Illegal arg\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_gpio_cli.c", 25); } } while (0 == 1); };
        return;
    }
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_gpio_cli)) { bl_printk("%s (%d)[%s:%4d] " "GPIO%d is set %s with %s pullup %s pulldown\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_gpio_cli.c", 28, ionum, inputmode ? "input" : "output", pullup ? "Active" : "null", pulldown ? "Active" : "null"); } } while (0 == 1); }
...
static void cmd_gpio_set(char *buf, int len, int argc, char **argv)
{
    ...
    if (3 != argc) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_gpio_cli)) { bl_printk("%s (%d)[%s:%4d] " "Usage: %s 24 1\r\n  set GPIO24 output to high\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_gpio_cli.c", 46, argv[0]); } } while (0 == 1); }
    ...
    val = atoi(argv[2]);
    if (ionum < 0 || val < 0) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_gpio_cli)) { bl_printk("%s (%d)[%s:%4d] " "Illegal arg\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_gpio_cli.c", 54); } } while (0 == 1); };
        return;
    }
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_gpio_cli)) { bl_printk("%s (%d)[%s:%4d] " "GPIO%d is set to %s\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_gpio_cli.c", 57, ionum, val ? "high" : "lo"); } } while (0 == 1); }
...
static void cmd_gpio_get(char *buf, int len, int argc, char **argv)
{
    ...
    ((void)(ret));
    if (2 != argc) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_gpio_cli)) { bl_printk("%s (%d)[%s:%4d] " "Usage: %s 24\r\n  get GPIO24 value\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_gpio_cli.c", 71, argv[0]); } } while (0 == 1); }
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_gpio_cli)) { bl_printk("%s (%d)[%s:%4d] " "GPIO%d val is %s\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_gpio_cli.c", 82, ionum, 0 == ret ? (val ? "high" : "low") : "Err"); } } while (0 == 1); }
