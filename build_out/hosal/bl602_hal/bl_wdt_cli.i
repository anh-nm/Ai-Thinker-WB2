# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_wdt_cli.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_wdt_cli.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_wdt_cli.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_wdt_cli.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_wdt_cli.c" 2
...
# 83 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymf_level_hosalbl_wdt_cli;
    const blog_info_t _fsymf_info_hosalbl_wdt_cli __attribute__((used, section(".static_blogfile_code." "hosalbl_wdt_cli"))) = { (blog_level_t *)(&_fsymf_level_hosalbl_wdt_cli), (char *)("hosal.bl_wdt_cli")};
...
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_wdt_cli.c" 2
...
static void cmd_wdt_init(char *buf, int len, int argc, char **argv)
{
    ...
    if (2 != argc) {
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_ERROR >= _fsymc_level_hosal) && (BLOG_LEVEL_ERROR >= _fsymf_level_hosalbl_wdt_cli)) { bl_printk("%s (%d)[%s:%4d] " "Usage: %s ms\r\n""\x1b[0m" "\r\n", "\x1b[31mERROR", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_wdt_cli.c", 13, argv[0]); } } while (0 == 1); };
        return;
    }
    ms = atoi(argv[1]);
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_hosal) && (BLOG_LEVEL_INFO >= _fsymf_level_hosalbl_wdt_cli)) { bl_printk("%s (%d)[%s:%4d] " "Init WDT with %dms\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "bl_wdt_cli.c", 17, ms); } } while (0 == 1); };
    if (ms <= 0) {
        return;
    }
    bl_wdt_init(ms);
