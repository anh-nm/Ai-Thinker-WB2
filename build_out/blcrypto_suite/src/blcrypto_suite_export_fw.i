# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/blcrypto_suite/src/blcrypto_suite_export_fw.c"
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/blcrypto_suite/priv_inc/bl_crypto_api.h" 2
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/blcrypto_suite/src/blcrypto_suite_export_fw.c" 2
...
int crypto_ec_point_cmp(const struct crypto_ec *e,
        const struct crypto_ec_point *a,
        const struct crypto_ec_point *b);
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/security/blcrypto_suite/src/blcrypto_suite_export_fw.c" 2



static const struct bl_crypto_api fw_api = {
    .crypto_bignum_init = crypto_bignum_init,
    .crypto_bignum_init_set = crypto_bignum_init_set,
    .crypto_bignum_deinit = crypto_bignum_deinit,
    .crypto_bignum_to_bin = crypto_bignum_to_bin,
    .crypto_bignum_add = crypto_bignum_add,
    .crypto_bignum_mod = crypto_bignum_mod,
    .crypto_bignum_exptmod = crypto_bignum_exptmod,
    .crypto_bignum_inverse = crypto_bignum_inverse,
    .crypto_bignum_sub = crypto_bignum_sub,
    .crypto_bignum_div = crypto_bignum_div,
    .crypto_bignum_mulmod = crypto_bignum_mulmod,
    .crypto_bignum_cmp = crypto_bignum_cmp,
    .crypto_bignum_bits = crypto_bignum_bits,
    .crypto_bignum_is_zero = crypto_bignum_is_zero,
    .crypto_bignum_is_one = crypto_bignum_is_one,
    .crypto_bignum_legendre = crypto_bignum_legendre,
    .crypto_ec_init = crypto_ec_init,
    .crypto_ec_deinit = crypto_ec_deinit,
    .crypto_ec_prime_len = crypto_ec_prime_len,
    .crypto_ec_prime_len_bits = crypto_ec_prime_len_bits,
    .crypto_ec_get_prime = crypto_ec_get_prime,
    .crypto_ec_get_order = crypto_ec_get_order,
    .crypto_ec_point_init = crypto_ec_point_init,
    .crypto_ec_point_deinit = crypto_ec_point_deinit,
    .crypto_ec_point_to_bin = crypto_ec_point_to_bin,
    .crypto_ec_point_from_bin = crypto_ec_point_from_bin,
    .crypto_ec_point_add = crypto_ec_point_add,
    .crypto_ec_point_mul = crypto_ec_point_mul,
    .crypto_ec_point_invert = crypto_ec_point_invert,
    .crypto_ec_point_solve_y_coord = crypto_ec_point_solve_y_coord,
    .crypto_ec_point_compute_y_sqr = crypto_ec_point_compute_y_sqr,
    .crypto_ec_point_is_at_infinity = crypto_ec_point_is_at_infinity,
    .crypto_ec_point_is_on_curve = crypto_ec_point_is_on_curve,
    .crypto_ec_point_cmp = crypto_ec_point_cmp,
};
