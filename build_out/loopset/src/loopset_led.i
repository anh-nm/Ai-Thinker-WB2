# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c"
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/applications/get-started/config_wifi/build_out/loopset//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 3 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 2

# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/utils/include/utils_debug.h" 1
# 7 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 69 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
    blog_level_t _fsymc_level_loopset __attribute__((weak));
...
# 9 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 11 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 12 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 13 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 2
...
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c" 3 4
   ((void *)0)
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c"
...
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c"
        ...
        if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_INFO >= _fsymc_level_loopset) && (BLOG_LEVEL_INFO >= _fsymf_level_loopsetloopset_led)) { bl_printk("%s (%d)[%s:%4d] " "[LED] New Trigger: PIN %d, active level %s, type %s\r\n""\x1b[0m" "\r\n", "\x1b[32mINFO", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "loopset_led.c", 42, node->pin, node->active ? "Hi" : "Lo", node->type ? "Hearbeat" : "Blink"); } } while (0 == 1); }
...
{
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_loopset) && (BLOG_LEVEL_DEBUG >= _fsymf_level_loopsetloopset_led)) { bl_printk("%s (%d)[%s:%4d] " "[LED] [MSG] called with msg info\r\n" "    priority %u\r\n" "    dst %u\r\n" "    msgid %u\r\n" "    src %u\r\n" "    arg1 %p\r\n" "    arg2 %p\r\n""\x1b[0m" "\r\n", "\x1b[30mDEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "loopset_led.c", 78, msg->u.header.priority, msg->u.header.id_dst, msg->u.header.id_msg, msg->u.header.id_src, msg->arg1, msg->arg2); } } while (0 == 1); }
# 91 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c"
     ;
    return 0;
}
...
static void _cb_led_trigger(struct loop_ctx *loop, struct loop_timer *timer, void *arg)
{
    ...
    if (0 == BLOG_HARD_DECLARE_DISABLE) { do { if ((BLOG_LEVEL_DEBUG >= _fsymc_level_loopset) && (BLOG_LEVEL_DEBUG >= _fsymf_level_loopsetloopset_led)) { bl_printk("%s (%d)[%s:%4d] " "[LED] [CB] Set pin %d to %s\r\n""\x1b[0m" "\r\n", "\x1b[30mDEBUG", (xPortIsInsideInterrupt()) ? (xTaskGetTickCountFromISR()) : (xTaskGetTickCount()), "loopset_led.c", 117, trigger->pin, trigger->current_val ? "Hi" : "Lo"); } } while (0 == 1); }
...
void loopset_led_trigger(int pin, unsigned int timeon_ms)
{
    ...
    do { if (!(trigger)) { do { ; bl_printk("[%10u][%s: %s:%4d] " "ASSERT: %s:%d\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ASSERT", "loopset_led.c", 129, "loopset_led.c", 129); ; } while(0==1); while (1) { } } } while (0);
