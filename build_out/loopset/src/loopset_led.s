...
.LC3:
	...
	.align	2
.LC4:
	.string	"%s (%d)[%s:%4d] [LED] [CB] Set pin %d to %s\r\n\033[0m\r\n"
	.section	.text._cb_led_trigger,"ax",@progbits
	.align	1
	.type	_cb_led_trigger, @function
_cb_led_trigger:
.LFB30:
	.file 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c"
	.loc 1 113 1
	.cfi_startproc
.LVL0:
	.loc 1 114 5
...
.LVL3:
	...
	.loc 1 117 43
	.loc 1 117 48
	.loc 1 117 70 is_stmt 0
	lui	a5,%hi(_fsymc_level_loopset)
	.loc 1 117 51
	lw	a4,%lo(_fsymc_level_loopset)(a5)
	li	a5,1
	bgtu	a4,a5,.L2
	.loc 1 117 116 discriminator 3
	lui	a4,%hi(_fsymf_level_loopsetloopset_led)
	.loc 1 117 95 discriminator 3
	lw	a4,%lo(_fsymf_level_loopsetloopset_led)(a4)
	bgtu	a4,a5,.L2
	.loc 1 117 155 is_stmt 1 discriminator 5
	.loc 1 117 253 is_stmt 0 discriminator 5
	call	xPortIsInsideInterrupt
.LVL4:
	.loc 1 117 155 discriminator 5
	beq	a0,zero,.L3
	.loc 1 117 282 discriminator 7
	call	xTaskGetTickCountFromISR
.LVL5:
.L8:
	.loc 1 117 155 discriminator 8
	lw	a4,56(s0)
	lw	a5,48(s0)
	.loc 1 117 313 discriminator 8
	mv	a2,a0
	.loc 1 117 155 discriminator 8
	bne	a4,zero,.L6
	.loc 1 117 155
	...
	addi	a6,a6,%lo(.LC1)
.L5:
	.loc 1 117 155 discriminator 14
	lui	a3,%hi(.LC2)
	lui	a1,%hi(.LC3)
	lui	a0,%hi(.LC4)
	li	a4,117
...
.LVL6:
.L2:
	.loc 1 117 418 is_stmt 1 discriminator 15
	.loc 1 120 6 discriminator 15
	.loc 1 121 5 discriminator 15
	.loc 1 121 28 is_stmt 0 discriminator 15
	lw	a5,56(s0)
	.loc 1 122 1 discriminator 15
	lw	ra,12(sp)
	.cfi_remember_state
	.cfi_restore 1
	.loc 1 121 28 discriminator 15
	seqz	a5,a5
	.loc 1 121 26 discriminator 15
	sw	a5,56(s0)
	.loc 1 122 1 discriminator 15
	lw	s0,8(sp)
	.cfi_restore 8
...
.LFE30:
	...
	.align	2
.LC5:
	.string	"%s (%d)[%s:%4d] [LED] [MSG] called with msg info\r\n    priority %u\r\n    dst %u\r\n    msgid %u\r\n    src %u\r\n    arg1 %p\r\n    arg2 %p\r\n\033[0m\r\n"
...
.LVL10:
	...
	.loc 1 78 43
	.loc 1 78 48
	.loc 1 78 70 is_stmt 0
	lui	a5,%hi(_fsymc_level_loopset)
	.loc 1 78 51
	lw	a4,%lo(_fsymc_level_loopset)(a5)
	li	a5,1
	bgtu	a4,a5,.L14
	.loc 1 78 116 discriminator 3
	lui	a4,%hi(_fsymf_level_loopsetloopset_led)
	.loc 1 78 95 discriminator 3
	lw	a4,%lo(_fsymf_level_loopsetloopset_led)(a4)
	bgtu	a4,a5,.L14
	.loc 1 77 1
	addi	sp,sp,-32
...
.LBB18:
.LBB19:
	.loc 1 78 155 is_stmt 1
	.loc 1 78 369 is_stmt 0
	call	xPortIsInsideInterrupt
.LVL12:
	.loc 1 78 155
	beq	a0,zero,.L11
...
.LC8:
	...
	.align	2
.LC9:
	.string	"%s (%d)[%s:%4d] [LED] New Trigger: PIN %d, active level %s, type %s\r\n\033[0m\r\n"
	.align	2
.LC10:
...
.LBB42:
	...
	lw	a4,%lo(_fsymf_level_loopsetloopset_led)(a4)
	bgtu	a4,a5,.L25
	.loc 1 42 157 is_stmt 1
	.loc 1 42 278 is_stmt 0
	call	xPortIsInsideInterrupt
.LVL34:
	.loc 1 42 157
	beq	a0,zero,.L26
...
.LC14:
	...
	.comm	_fsymf_level_loopsetloopset_led,4,4
	.align	2
.LC15:
	.string	"loopset"
...
.Letext0:
	...
	.file 8 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/bloop/include/bloop.h"
	...
	.file 13 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/platform/hosal/bl602_hal/bl_gpio.h"
	.file 14 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/looprt/include/looprt.h"
...
.LASF119:
	.string	"/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/sys/bloop/loopset/src/loopset_led.c"
.LASF86:
	.string	"timeon_ms"
.LASF17:
