# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c"
...
# 2 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c" 2
...
# 4 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c" 2
...
# 5 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c" 2
# 1 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h" 1
# 36 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/blog/blog.h"
...
# 6 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c" 2
...
void psm_test_cmd(char *buf, int len, int argc, char **argv)
{
    ...
    uint8_t *data_src = 
# 40 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c" 3 4
                       ((void *)0)
# 40 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c"
                           ;
    uint8_t *data_buf = 
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c" 3 4
                       ((void *)0)
# 41 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c"
                           ;
    uint32_t data_len = 0;
    ...
    for (j = 0; j < sizeof(tbuf)/sizeof(tbuf[0]); j++) {
        ...
        if ((
# 55 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c" 3 4
            ((void *)0) 
# 55 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c"
                 == data_src) || (
# 55 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c" 3 4
                                  ((void *)0) 
# 55 "/home/anh/Desktop/wb2/Ai-Thinker-WB2/components/stage/easyflash4/src/easyflash_cli.c"
                                       == data_buf)) {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "kvbin malloc %d byte error\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "easyflash_cli.c", 56); ; } while(0==1);
            goto kvbin_exit;
        }
        ...
        if ((res1 != 0) || (res2 != data_len)) {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "kvbin set/get %ld byte error, res1 = %ld, res2 = %d.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "WARN  ", "easyflash_cli.c", 72, data_len, res1, res2); ; } while(0==1);
            goto kvbin_exit;
        }

        if (memcmp(data_buf, data_src, data_len) != 0) {
            do { ; bl_printk("[%10u][%s: %s:%4d] " "kvbin set/get %ld byte , res1 = %ld, res2 = %d. memcmp error\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ERROR ", "easyflash_cli.c", 77, data_len, res1, res2); ; } while(0==1);
            goto kvbin_exit;
        }

        do { ; bl_printk("[%10u][%s: %s:%4d] " "kvbin set %ld byte bin -> read %ld byte -> memcmp success.\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "INFO  ", "easyflash_cli.c", 81, data_len, data_len); ; } while(0==1);
kvbin_exit:
        if (data_src) {
            vPortFree(data_src);
        }
